/*:============================================================================
  ...
  @plugindesc | Mimosa Mouse Cursor : Version - 1.2.0 | This plugin allows you to change the cursor of your mouse while in the game window!.
...
if ( Utils.RPGMAKER_NAME == 'MV' ) {
  ...
  //-----------------------------------------------------------------------------
      ...
      const pictures = this._pictureContainer.children;
      const cursor = Chaucer.mmCursor._mouseCursor;
