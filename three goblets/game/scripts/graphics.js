...
define(['lib/pixi'], function (PIXI) {
  ...
  var Graphics = /*#__PURE__*/function () {
    function Graphics() {
      ...
      this.renderer = new PIXI.CanvasRenderer(160 * 4, 144 * 4, {
        view: document.getElementById("screenCanvas"),
        transparent: true
      });
    ...
    _createClass(Graphics, [{
      ...
      value: function loadInitResources(config, callback) {
        ...
        config.logos.forEach(function (logoData) {
          ...
          loader.add(logoData.source, 'assets/' + logoData.source + ext, {
            metadata: metadata
          });
        });
        loader.load(function (loader, resources) {
          Object.values(resources).forEach(function (resource) {
            if (resource.metadata.logoType) {
              ...
              _this2.logos.push({
                type: resource.metadata.logoType,
                url: resource.url.match(/^(.*)\./)[1],
      ...
      value: function newText(text) {
        var sprite = new PIXI.extras.BitmapText(text.toString(), {
          font: '10px Munro'
        });
        return sprite;
      }
      ...
      value: function generateMonsterSizes(resource) {
        ...
        monsterFrames.forEach(function (_ref15) {
          ...
          return _this7.monsterSizes[name] = {
            w: frameObj.frame.w,
            h: frameObj.frame.h
          };
        });
