  ...
  var Panels = /*#__PURE__*/function () {
    ...
    _createClass(Panels, [{
      ...
      value: function initializeSwitchers() {
        ...
        this.switchers.lower = new PanelSwitcher(['Inventory', 'Passives'], 'bot', 138); //this.switchers.settings = new PanelSwitcher(['Settings'], 'top', 148)
      }
    }, {
      key: "initializeDraggedItemSprites",
      value: function initializeDraggedItemSprites() {
        this.itemSprites = {};
        this.itemSprites.rect = game.graphics.addRect({
          x: 0,
          y: 0,
          w: 16,
          h: 16
      ...
      value: function updateDraggedItemSprites() {
        ...
        if (dragged) {
          ...
          game.graphics.redrawRect(this.itemSprites.rect, {
            x: 0,
            y: 0,
            w: 16,
            h: 16
          }, this.all['Inventory'].getFillColor(dragged), 2);
