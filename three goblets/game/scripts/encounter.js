    ...
    _createClass(Encounter, [{
      ...
      value: function getTargets(monster, type) {
        switch (type) {
          ...
          case 'spl':
            return this.getSplashTargets(monster);
            break;
      ...
      value: function summon(summoner, data) {
        ...
        for (var i = 0; i < data.count; i++) {
          ...
          monster.setStartingStates(); //console.log('before: ', this.active.slice());
          ...
          this.summonCount += 1; //console.log('after: ', this.active.map(m => m && m.hp > 0 ? m : 'dead'));
        }
      }
    }, {
