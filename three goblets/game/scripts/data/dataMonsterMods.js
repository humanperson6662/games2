...
define([''], function () {
  ...
  var monsterMods = {
    powerful: {
      icon: 1,
      multis: [['dmg', 4], ['mhp', 2], ['aps', 0.5]],
      specialAttack: true,
      tooltip: 'Powerfull attacks:\nDeals 4x Damage.'
    },
    poison: {
      icon: 3,
      multis: [['mhp', 1.5], ['aps', 0.8]],
      stats: [['poi', 4]],
      specialAttack: true,
    ...
    slimesplita: {
      icon: 11,
      stats: [['div', 8]],
      tooltip: 'Splits itself after being destroyed,\nintroducing new dangers.'
    },
    slimesplitb: {
      icon: 11,
      stats: [['div', 9]],
