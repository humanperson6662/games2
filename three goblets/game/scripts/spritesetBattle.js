...
define(['game', 'spritePool'], function (game, SpritePool) {
  ...
  //*******************************************************************************************************************
  var SpritesetBattle = /*#__PURE__*/function () {
    ...
    _createClass(SpritesetBattle, [{
      ...
      value: function updateActiveMonsters() {
        ...
        game.encounter.getActive().forEach(function (monster, index) {
          ...
          var rect = _this2.rects[i] || {
            x: 0,
            y: 0,
            w: 0,
            h: 0
          };
          var center = rect.x + rect.w / 2; //if (!this.monsterSprites[i]) debugger
          ...
          game.graphics.redrawRect(_this2.rectSprites[i], {
            x: 0,
            y: 0,
            w: rect.w + 4,
            h: rect.h + 4
      ...
      value: function updateAllMonsters() {
        ...
        game.encounter.monsters.forEach(function (monster, i) {
          ...
          if (monster.timers.appear > 0) {
            ...
            _this3.monsterSprites[i].texture = game.graphics.getModifiedTexture('mon' + monster.graphic, 'appearing' + iter); //this.monsterSprites[i].scale.y = (6 - monster.timers.appear) / 5
          }
