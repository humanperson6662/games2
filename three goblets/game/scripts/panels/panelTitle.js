...
define(['game', 'panelBase'], function (game, PanelBase) {
  ...
  // ** The Title Panel
  //*******************************************************************************************************************
  var PanelTitle = /*#__PURE__*/function (_PanelBase) {
    _inherits(PanelTitle, _PanelBase);

    var _super = _createSuper(PanelTitle);
    ...
    _createClass(PanelTitle, [{
      ...
      value: function initialize() {
        _get(_getPrototypeOf(PanelTitle.prototype), "initialize", this).call(this);
      }
    }, {
      key: "setupSprites",
      value: function setupSprites() {
        _get(_getPrototypeOf(PanelTitle.prototype), "setupSprites", this).call(this);
