(function(){
    ...
    Game.addAction("prepare", function(){
        ...
        ARMOR_FRAMES[4] = new Utils.AnimationFrame(Game.Resources.textureBubbles, 164, 365, 47, 16);
        ARMOR_FRAMES[5] = new Utils.AnimationFrame(Game.Resources.textureBubbles, 164, 384, 48, 16);
        //14, 14, 397, 123
        //14, 156, 397, 123
        //14, 299, 347, 71
        //14, 389, 347, 71
    ...
    function createArmorButton(actual){
        ...
        button.bounds.xSize *= 0.085 * scale;
        button.bounds.ySize *= 0.085 * scale;
    ...
    function createFacebookButton(normal){
        ...
        button.bounds.xSize *= 0.097 * scale;
        button.bounds.ySize *= 0.097 * scale;
    ...
    function createArmorButtonLevel(){
        ...
        sprite.pinned = true;
        sprite.xMirror = true;
        ARMOR_FRAMES[4].applyToSprite(sprite);
        sprite.x = Engine.Renderer.xSizeView * 0.5;
        sprite.y = Engine.Renderer.ySizeView * 0.5 - sprite.ySize;
        sprite.x = sprite.x + 1;
        sprite.y = sprite.y + 1;
        var draw = {};
        draw.onDrawBubblesDialog = function(){
            sprite.render();
        };
        Engine.System.addListenersFrom(draw);
    }
    ...
    function createFacebookButtonLevel(){
        ...
        sprite.enabled = true;
        sprite.pinned = true;
        ARMOR_FRAMES[5].applyToSprite(sprite);
        sprite.x = -Engine.Renderer.xSizeView * 0.5;
        sprite.y = Engine.Renderer.ySizeView * 0.5 - sprite.ySize;
        sprite.x = sprite.x - 1;
        sprite.y = sprite.y + 1;
