...
(function (Engine) {
    ...
    */
    ...
    var Box = /** @class */ (function () {
        ...
        Box.prototype.playOnScreenAudio = function (audioPlayer) {
            if (Box.audioBox == null) {
                Box.audioBox = new Box();
                Box.audioBox.enabled;
            }
            Box.audioBox.x = Engine.Renderer.xCamera;
            Box.audioBox.y = Engine.Renderer.yCamera;
            Box.audioBox.xSize = Engine.Renderer.xSizeView;
            Box.audioBox.ySize = Engine.Renderer.ySizeView;
            Box.audioBox.xOffset = -Engine.Renderer.xSizeView * 0.5;
            Box.audioBox.yOffset = -Engine.Renderer.ySizeView * 0.5;
            if (this.collideAgainst(Box.audioBox, null, false, 0, false, Box.LAYER_ALL) != null) {
                audioPlayer.play();
            }
        };
        Box.UNIT = 1000.0;
...
(function (Engine) {
    ...
    var Renderer = /** @class */ (function () {
        ...
        */
        ...
        Renderer.clearRed = 26 / 255.0;
        Renderer.clearGreen = 26 / 255.0;
        Renderer.clearBlue = 26 / 255.0;
...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "noa", "minibubbles");
        }
        else {
            Engine.Data.setID("c", "n", "mbbl");
        }
...
(function (Game) {
    ...
    Game.X_BUTTONS_LEFT = 6;
    Game.X_BUTTONS_RIGHT = -6;
    Game.Y_BUTTONS_TOP = 3.5;
    Game.Y_BUTTONS_BOTTOM = -3.5;
    Game.Y_ARROWS_GAME_BUTTONS = 2;
    Game.X_SEPARATION_BUTTONS_LEFT = 7;
            ...
            var BaseEntity = /** @class */ (function (_super) {
                ...
                BaseEntity.prototype.platformCheck = function () {
                    ...
                    if (this.yDirContact > 0) {
                        this.onStartPlatformCheckY();
                        var overlaps = this.boxSolid.cast(Game.SceneMap.instance.boxesSolids, null, false, 1, false);
                        if (overlaps != null) {
                ...
                BaseEntity.prototype.onStartPlatformCheckY = function () { };
                BaseEntity.prototype.onEndPlatformCheckY = function () { };
                ...
                BaseEntity.prototype.yMoveOnPlatform = function (dist) {
                    this.onStartMoveOnPlatformY(dist);
                    ...
                    this.onEndMoveOnPlatformY();
                };
                BaseEntity.prototype.onStartMoveOnPlatformY = function (_dist) { };
                ;
                BaseEntity.prototype.onEndMoveOnPlatformY = function () { };
                ;
    ...
    (function (Arcade) {
        ...
        (function (Platformer) {
            ...
            var Platform = /** @class */ (function (_super) {
                ...
                Platform.prototype.onStartMoveY = function () { };
                Platform.prototype.onEndMoveY = function () { };
    ...
    (function (Interaction) {
        ...
        (function (Controls) {
            ...
            (function (Platformer) {
                ...
                var Y_MARGIN_CONTROLS = 5 * SCALE + 0.5;
                var X_SIZE_CONTROL = (63 + X_MARGIN_CONTROL * 2) * SCALE;
                var Y_SIZE_CONTROL = 100 * SCALE;
                var X_OFFSET_CONTROL = 10 * SCALE;
                var FRAMES;
                Game.addAction("configure", function () {
                    FRAMES = Game.FrameSelector.complex("controlsjump", Game.Resources.textureBubbles, 14, 477);
                });
...
(function (Game) {
    ...
    var SceneMap = /** @class */ (function (_super) {
        ...
        SceneMap.prototype.loadSky = function (_pathSky) {
        ...
        private createSky(){
            if(this.defSky != null){
                for(var layer of this.defSky.layers){
                    if(layer.name.indexOf("Entities") < 0 && layer.name.indexOf("Repeat") >= 0 && layer.name.indexOf("Ignore") < 0){
                        this.createRepeatLayer(layer);
                    }
                }
        ...
        */
        SceneMap.prototype.createSpriteTile = function (indexTile, x, y) {
            ...
            sprite.setFull(true, false, Game.Resources.textureBubbles, this.xSizeTile, this.ySizeTile, 0, 0, xTexture, yTexture, this.xSizeTile, this.ySizeTile);
            return sprite;
        };
...
(function (Game) {
    ...
    var Credits = /** @class */ (function (_super) {
        ...
        function Credits() {
            ...
            //var dialog = new ColorDialog("normal", 0, -56 * 0.5, 152 + 4 - 32 - 26, 56);
            var dialog = new Game.CreditsDialog();
            ...
            //noadev.xAligned = 1.5;
            noadev.yAligned = dialog.sprite.y + 4;
            ...
            musicCreator.yAligned = noadev2.y + 9;
            ...
            _this.backButton.dialog.enabled = false;
            var credBack = new Game.CreditsBack();
            credBack.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 - 7 - 0.5;
            _this.backButton.control.bounds = credBack.sprite;
            _this.loadMap(Game.Resources.PATH_MAP_SCREEN);
            //var x = Scene.xSizeLevel * 0.5;
            //var y = Scene.ySizeLevel * 0.5;
            //Engine.Renderer.camera(x, y);
            Game.SceneColors.enabledDown = true;
            //this.loadSky(Resources.PATH_MAP_SCREEN);
            new Game.SmallButtonDialog();
...
(function (Game) {
    ...
    var LastScene = /** @class */ (function (_super) {
        ...
        function LastScene() {
            ...
            _this.continueButton.control.bounds = Game.IS_TOUCH ? _this.continueButton.control.bounds : null;
            ...
            _this.continueButton.text.str = Game.IS_TOUCH ? "PRESS THE DOOR" : "ESC OR CLICK";
            ...
            _this.continueButton.text.yAligned = pos;
            ...
            text4.enabled = true;
            text4.pinned = true;
            text4.str = Game.IS_TOUCH ? "BUTTON TO CONTINUE" : "TO CONTINUE";
...
(function (Game) {
    ...
    var LevelSelection = /** @class */ (function (_super) {
        ...
        function LevelSelection() {
            ...
            _this.backButton.control.onReleasedDelegate = _this.backReleased;
            _this.backButton.dialog.enabled = false;
            var bckFrm = new Game.LevelSelectionButton();
            bckFrm.sprite.x = 0;
            bckFrm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * (Y_COUNT_BUTTONS + 0) + 2 + _this.yButtons2 - 0.5;
            _this.backButton.control.bounds = bckFrm.sprite;
            ...
            _this.switchButton.dialog.enabled = false;
            var swcFrm = new Game.LevelSelectionButton();
            swcFrm.sprite.x = _this.buttons[_this.buttons.length - 2].dialog.x + X_SIZE_BUTTON + X_SPEARATION_BUTTONS;
            swcFrm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 + _this.yButtons2 - 0.5;
            _this.switchButton.control.bounds = swcFrm.sprite;
            ...
            _this.switchButton2.dialog.enabled = false;
            var swc2Frm = new Game.LevelSelectionButton();
            swc2Frm.sprite.x = _this.buttons[0].dialog.x;
            swc2Frm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 + _this.yButtons2 - 0.5;
            _this.switchButton2.control.bounds = swc2Frm.sprite;
            _this.loadMap(Game.Resources.PATH_MAP_SCREEN);
            var x = _this.xSizeMap * 0.5;
        ...
        LevelSelection.prototype.createButtons = function () {
            ...
            for (var yIndex = 0; yIndex < Y_COUNT_BUTTONS; yIndex += 1) {
                for (var xIndex = 0; xIndex < X_COUNT_BUTTONS; xIndex += 1) {
                    ...
                    this.buttons[count].dialog.enabled = false;
                    this.buttonFrames[count] = new Game.LevelSelectionButton();
                    this.buttonFrames[count].sprite.x = x;
                    this.buttonFrames[count].sprite.y = y - 0.5;
                    this.buttons[count].control.bounds = this.buttonFrames[count].sprite;
                    count += 1;
                }
            }
        };
                ...
                if (count <= Game.MAX_LEVELS) {
                    ...
                    switch (Game.dataLevels[count]) {
                        case "locked":
                            ...
                            button.dialog.enabled = false;
                            this.buttonFrames[count2].fix(2);
                            break;
                        case "unlocked":
                            button.enabled = true;
                            button.dialog.enabled = false;
                            ...
                            this.buttonFrames[count2].fix(1);
                            break;
                        case "cleared":
                            button.enabled = true;
                            button.dialog.enabled = false;
                            button.text.font = Game.FontManager.a;
                            button.arrows.font = Game.FontManager.a;
                            this.buttonFrames[count2].fix(0);
                            break;
                    }
                    count += 1;
                }
...
(function (Game) {
    var DESKTOP_FRAME;
    var DESKTOP_NO_LINK_FRAME;
    var MOB_BUTT_FRAME;
    Game.addAction("configure", function () {
        DESKTOP_FRAME = Game.FrameSelector.complex("dskFrm", Game.Resources.textureBubbles, 14, 272)[0];
        DESKTOP_NO_LINK_FRAME = Game.FrameSelector.complex("dskFrmNoLink", Game.Resources.textureBubbles, 191, 166)[0];
        MOB_BUTT_FRAME = Game.FrameSelector.complex("mobBut", Game.Resources.textureBubbles, 137, 293)[0];
    });
    ...
    var MainMenu = /** @class */ (function (_super) {
        ...
        function MainMenu() {
            var _this = _super.call(this) || this;
            _this.desktopFrame = null;
            _this.starttouch = null;
            _this.speedruntouch = null;
            _this.creditstouch = null;
            _this.moregamestouch = null;
            ...
            if (Game.IS_TOUCH) {
                ...
                if (Game.HAS_LINKS) {
                    ...
                    ypos = -19;
                    yoff = 22;
                    _this.starttouch = new Engine.Sprite();
                    _this.starttouch.enabled = true;
                    _this.starttouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.starttouch);
                    _this.starttouch.x = xpos;
                    _this.starttouch.y = ypos;
                    _this.speedruntouch = new Engine.Sprite();
                    _this.speedruntouch.enabled = true;
                    _this.speedruntouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.speedruntouch);
                    _this.speedruntouch.x = xpos + xoff;
                    _this.speedruntouch.y = ypos;
                    _this.creditstouch = new Engine.Sprite();
                    _this.creditstouch.enabled = true;
                    _this.creditstouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.creditstouch);
                    _this.creditstouch.x = xpos;
                    _this.creditstouch.y = ypos + yoff;
                    _this.moregamestouch = new Engine.Sprite();
                    _this.moregamestouch.enabled = true;
                    _this.moregamestouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.moregamestouch);
                    _this.moregamestouch.x = xpos + xoff;
                    _this.moregamestouch.y = ypos + yoff;
                    ...
                    _this.starttouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.starttouch);
                    _this.starttouch.x = 0;
                    _this.starttouch.y = ypos;
                    _this.speedruntouch = new Engine.Sprite();
                    _this.speedruntouch.enabled = true;
                    _this.speedruntouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.speedruntouch);
                    _this.speedruntouch.x = 0;
                    _this.speedruntouch.y = ypos + yoff;
                    _this.creditstouch = new Engine.Sprite();
                    _this.creditstouch.enabled = true;
                    _this.creditstouch.pinned = true;
                    MOB_BUTT_FRAME.applyToSprite(_this.creditstouch);
                    _this.creditstouch.x = 0;
                    _this.creditstouch.y = ypos + yoff * 2;
                    //this.starttouch = new ColorDialog("normal", 0, ypos, xsize, ysize);
                    //this.speedruntouch = new ColorDialog("normal", 0, ypos + yoff, xsize, ysize);
                    //this.creditstouch = new ColorDialog("normal", 0, ypos + yoff * 2, xsize, ysize);
                }
                _this.start.text.xAligned = _this.starttouch.x;
                _this.start.text.yAligned = _this.starttouch.y + 4.5;
                _this.start.control.bounds = _this.starttouch;
                _this.speedrun.text.xAligned = _this.speedruntouch.x;
                _this.speedrun.text.yAligned = _this.speedruntouch.y + 4.5;
                _this.speedrun.control.bounds = _this.speedruntouch;
                _this.credits.text.xAligned = _this.creditstouch.x;
                _this.credits.text.yAligned = _this.creditstouch.y + 4.5;
                _this.credits.control.bounds = _this.creditstouch;
                if (Game.HAS_LINKS) {
                    _this.moregames.text.xAligned = _this.moregamestouch.x;
                    _this.moregames.text.yAligned = _this.moregamestouch.y + 4.5;
                    _this.moregames.control.bounds = _this.moregamestouch;
                ...
                _this.desktopFrame = new Engine.Sprite();
                _this.desktopFrame.enabled = true;
                _this.desktopFrame.pinned = true;
                if (Game.HAS_LINKS) {
                    DESKTOP_FRAME.applyToSprite(_this.desktopFrame);
                    _this.desktopFrame.y = 1;
                    //new ColorDialog("normal", 0, -19, 60, 36);
                    var ofsExt = 3;
                    _this.start.text.yAligned = -60 + 44 + 0 + ofsExt;
                    _this.speedrun.text.yAligned = -60 + 44 + 7 + ofsExt;
                    _this.credits.text.yAligned = -60 + 44 + 14 + ofsExt;
                    _this.moregames.text.yAligned = -60 + 44 + 21 + ofsExt;
                    _this.moregames.text.underlined = true;
                }
                else {
                    DESKTOP_NO_LINK_FRAME.applyToSprite(_this.desktopFrame);
                    _this.desktopFrame.y = -0.5;
                    //new ColorDialog("normal", 0, -19 + 6, 60, 27);
            ...
            _this.noadev.text.yAligned = 60 + 2 + ((Game.IS_TOUCH && !Game.HAS_LINKS) ? -3.5 : (Game.HAS_LINKS_NOADEV ? -6 : -7.5));
            //this.noadev.arrows.enabled = false;
            //}
            //new ColorDialog("normal", 0, this.noadev.text.yAligned - 8 - 6 + 3 - 1 + 1, 58 + 5, 15);
            var x = _this.xSizeMap * 0.5;
            var y = _this.ySizeMap * 0.5;
            Engine.Renderer.camera(x, y);
            //this.fillBlue.enabled = true;
            //SceneColors.enabledDown = true;
            //this.loadSky(Resources.PATH_MAP_SKY_1X1);
            new Game.SmallButtonDialog();
        ...
        MainMenu.prototype.onDrawBubblesDialog = function () {
            if (this.starttouch != null) {
                this.starttouch.render();
                this.speedruntouch.render();
                this.creditstouch.render();
                if (this.moregamestouch != null) {
                    this.moregamestouch.render();
                }
            }
        };
        return MainMenu;
...
(function (Game) {
    ...
    var SpeedrunMenu = /** @class */ (function (_super) {
        ...
        function SpeedrunMenu() {
            ...
            new Game.MusicButton();
            new Game.SoundButton();
            //new ColorDialog("normal", 5, -54 * 0.5 - 7 + 0.5, 152 + 4 - 32 - 26, 54);
            var frame = new Game.SpeedrunFrame();
            frame.sprite.y -= 6;
            ...
            recordA.xAligned = 0;
            recordA.yAligned = frame.sprite.y + 4;
            ...
            _this.newButton.dialog.enabled = false;
            var newFrm = new Game.SpeedrunButton();
            newFrm.sprite.x = -X_SIZE_BUTTON - 5 - X_SPEARATION_BUTTONS + 0.5;
            newFrm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 - 7 - 0.5 - 0.5;
            _this.newButton.control.bounds = newFrm.sprite;
            ...
            _this.continueButton.dialog.enabled = false;
            if (Game.dataSpeedrun > 0) {
                var continueFrm = new Game.SpeedrunButton();
                continueFrm.sprite.x = 0 + 0.5;
                continueFrm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 - 7 - 0.5 - 0.5;
                _this.continueButton.control.bounds = continueFrm.sprite;
            }
            ...
            _this.backButton.control.onReleasedDelegate = _this.backReleased;
            _this.backButton.dialog.enabled = false;
            var bckFrm = new Game.SpeedrunButton();
            bckFrm.sprite.x = X_SIZE_BUTTON + 5 + X_SPEARATION_BUTTONS + 0.5;
            bckFrm.sprite.y = _this.yButtons + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 - 7 - 0.5 - 0.5;
            _this.backButton.control.bounds = bckFrm.sprite;
            _this.loadMap(Game.Resources.PATH_MAP_SCREEN);
            //var x = Scene.xSizeLevel * 0.5;
            //var y = Scene.ySizeLevel * 0.5;
...
(function (Game) {
    ...
    var Preloader = /** @class */ (function (_super) {
        ...
        function Preloader() {
            ...
            _this.text.yAlignView = Utils.AnchorAlignment.MIDDLE;
            _this.text.xAligned = 0;
            _this.text.yAligned = Y_LOADING - 2;
            ...
            _this.bar = new Game.LoadingBar(-60 + 61 - 2);
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("exit button", Game.Resources.textureBubbles, 76, 258);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("music button", Game.Resources.textureBubbles, 76, 258);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("pause button", Game.Resources.textureBubbles, 76, 258);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("reset button", Game.Resources.textureBubbles, 76, 258);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("sound button", Game.Resources.textureBubbles, 76, 258);
    });
...
(function (Game) {
    var LevelText = /** @class */ (function (_super) {
        ...
        function LevelText() {
            ...
            _this.text0.yAligned = Game.Y_BUTTONS_TOP + (Game.Level.speedrun ? -2 : 2) - 1 * 0;
            if (Game.IS_TOUCH) {
        ...
        LevelText.prototype.fix = function () {
            if (Engine.Renderer.xSizeView >= 240) {
                ...
                this.text0.xAligned = 134 * 0.5 + (Engine.Renderer.xSizeView - 43 * 0.5 - 134 * 0.5) * 0.5 + 2;
            }
        };
...
(function (Game) {
    var FontManager = /** @class */ (function () {
        ...
        FontManager.createFondts = function () {
            ...
            FontManager.a.setFull(Game.Resources.textureBubbles, 14, 176, 1);
            FontManager.b = new Utils.Font();
            FontManager.b.setFull(Game.Resources.textureBubbles, 14, 176, 1);
            FontManager.c = new Utils.Font();
            FontManager.c.setFull(Game.Resources.textureBubbles, 14, 176, 1);
            FontManager.ads = new Utils.Font();
            FontManager.ads.setFull(Game.Resources.textureBubbles, 14, 176, 1);
        };
        return FontManager;
    }());
...
var Game;
(function (Game) {
    var PATH_BGM = "Assets/Audio/Komiku_-_32_-_Love_Planet.omw";
    var PATH_SFX_MBUB_JUMP = "Assets/Audio/mbub-jump.wom";
    var PATH_SFX_MBUB_POP = "Assets/Audio/mbub-pop.wom";
    var PATH_SFX_MBUB_LOSE = "Assets/Audio/mbub-lose.wom";
    var PATH_SFX_MBUB_WIN = "Assets/Audio/mbub-win.wom";
    var PATH_SFX_MBUB_FORM = "Assets/Audio/mbub-form.wom";
    var PATH_SFX_MBUB_LASER = "Assets/Audio/mbub-laser.wom";
    Game.PTH_TEX_BUBBLES = "Assets/Graphics/Bubbles.png";
    ...
    var Resources = /** @class */ (function () {
        ...
        Resources.PATH_MAP_SKY_1X1 = Resources.PATH_MAPS + "Sky1x1.json";
        Resources.PATH_MAP_SCREEN = Resources.PATH_MAPS + "Screen.json";
    ...
    Game.addPath("preload", Game.PTH_TEX_BUBBLES);
    ...
    Game.addPath("preload", Resources.PATH_MAP_SKY_1X1);
    Game.addPath("preload", Resources.PATH_MAP_PRELOADER);
    Game.addPath("load", Resources.PATH_MAP_SCREEN);
    ...
    Game.addPath("load", PATH_SFX_MBUB_JUMP);
    Game.addPath("load", PATH_SFX_MBUB_POP);
    Game.addPath("load", PATH_SFX_MBUB_LOSE);
    Game.addPath("load", PATH_SFX_MBUB_WIN);
    Game.addPath("load", PATH_SFX_MBUB_FORM);
    Game.addPath("load", PATH_SFX_MBUB_LASER);
    Game.addAction("preinit", function () {
        ...
        Resources.textureBubbles = new Engine.Texture(Game.PTH_TEX_BUBBLES, true, false);
        Resources.textureBubbles.preserved = true;
        if (Game.HAS_LINKS && Game.HAS_GOOGLE_PLAY_LOGOS) {
    ...
    Game.addAction("configure", function () {
        ...
        Resources.bgm.loopStart = 0.0820 * 0;
        //Resources.bgm.loopStart = 0.0840;
        //Resources.bgm.loopStart = 0.0860;
        Resources.bgm.loopEnd = 80.036280; //540;
        Game.bgms.push(Resources.bgm);
        Resources.sfxMBubJump = new Engine.AudioPlayer(PATH_SFX_MBUB_JUMP);
        Resources.sfxMBubJump.preserved = true;
        Resources.sfxMBubJump.volume = Resources.sfxMBubJump.restoreVolume = 1.80 * vscale;
        Game.sfxs.push(Resources.sfxMBubJump);
        Resources.sfxMBubPop = new Engine.AudioPlayer(PATH_SFX_MBUB_POP);
        Resources.sfxMBubPop.preserved = true;
        Resources.sfxMBubPop.volume = Resources.sfxMBubPop.restoreVolume = 1.80 * vscale;
        Game.sfxs.push(Resources.sfxMBubPop);
        Resources.sfxMBubForm = new Engine.AudioPlayer(PATH_SFX_MBUB_FORM);
        Resources.sfxMBubForm.preserved = true;
        Resources.sfxMBubForm.volume = Resources.sfxMBubForm.restoreVolume = 1.60 * vscale;
        Game.sfxs.push(Resources.sfxMBubForm);
        Resources.sfxMBubLose = new Engine.AudioPlayer(PATH_SFX_MBUB_LOSE);
        Resources.sfxMBubLose.preserved = true;
        Resources.sfxMBubLose.volume = Resources.sfxMBubLose.restoreVolume = 1.50 * vscale;
        Game.sfxs.push(Resources.sfxMBubLose);
        Resources.sfxMBubWin = new Engine.AudioPlayer(PATH_SFX_MBUB_WIN);
        Resources.sfxMBubWin.preserved = true;
        Resources.sfxMBubWin.volume = Resources.sfxMBubWin.restoreVolume = 1.50 * vscale;
        Game.sfxs.push(Resources.sfxMBubWin);
        Resources.sfxMBubLaser = new Engine.AudioPlayer(PATH_SFX_MBUB_LASER);
        Resources.sfxMBubLaser.preserved = true;
        Resources.sfxMBubLaser.volume = Resources.sfxMBubLaser.restoreVolume = 1.00 * vscale;
        Game.sfxs.push(Resources.sfxMBubLaser);
...
(function (Utils) {
    ...
    var FixedText = /** @class */ (function (_super) {
        ...
        FixedText.prototype.setEnabled = function (value) {
            this._enabled = value;
            for (var _i = 0, _a = this.sprites; _i < _a.length; _i++) {
                var sprite = _a[_i];
                sprite.enabled = false;
        ...
        Object.defineProperty(FixedText.prototype, "enabled", {
            get: function () {
                return this._enabled;
            },
            set: function (value) {
        ...
        Object.defineProperty(FixedText.prototype, "pinned", {
            get: function () {
                return this._pinned;
            },
            set: function (value) {
        ...
        Object.defineProperty(FixedText.prototype, "str", {
            get: function () {
                return this._str;
            },
            set: function (value) {
        ...
        Object.defineProperty(FixedText.prototype, "font", {
            get: function () {
                return this._font;
            },
            set: function (value) {
        ...
        Object.defineProperty(FixedText.prototype, "scale", {
            get: function () {
                return this._scale;
            },
            set: function (value) {
        ...
        FixedText.prototype.fixStr = function () {
            if (this._str != null && this._font != null) {
                for (var indexSprite = this.sprites.length; indexSprite < this._str.length; indexSprite += 1) {
                    this.sprites.push(new Engine.Sprite());
                }
        ...
        FixedText.prototype.fix = function () {
            if (this._str != null && this._font != null) {
                var x = this._x;
                for (var indexChar = 0; indexChar < this._str.length; indexChar += 1) {
                    var sprite = this.sprites[indexChar];
        ...
        FixedText.prototype.setPos = function (x, y) {
            this._x = x;
            this._y = y;
            this.fix();
        };
        FixedText.prototype.onViewUpdateText = function () {
            this.fix();
        };
        FixedText.prototype.onDrawTextSuperBack = function () {
            if (this.superback) {
                //this._bounds.render();
                for (var indexSprite = 0; indexSprite < this.sprites.length; indexSprite += 1) {
                    this.sprites[indexSprite].render();
        ...
        FixedText.prototype.onDrawText = function () {
            if (!this.front && !this.superback) {
                //this._bounds.render();
                for (var indexSprite = 0; indexSprite < this.sprites.length; indexSprite += 1) {
                    this.sprites[indexSprite].render();
        ...
        FixedText.prototype.onDrawTextFront = function () {
            if (this.front && !this.superback) {
                //this._bounds.render();
                for (var indexSprite = 0; indexSprite < this.sprites.length; indexSprite += 1) {
                    this.sprites[indexSprite].render();
    ...
    Utils.FixedText = FixedText;
})(Utils || (Utils = {}));
var Utils;
(function (Utils) {
    var Animation = /** @class */ (function () {
        function Animation(name, loop, frames, steps, indexArray, stepArray, loopStart) {
...
(function (Utils) {
    var AnimationFrame = /** @class */ (function () {
        ...
        AnimationFrame.prototype.applyToBox = function (box, xMirror, yMirror) {
            if (xMirror === void 0) { xMirror = false; }
            if (yMirror === void 0) { yMirror = false; }
            if (this.hasBox) {
                box.xSize = this.xSizeBox;
                box.ySize = this.ySizeBox;
                if (xMirror)
                    box.xOffset = -this.xOffsetBox - this.xSizeBox;
                else
                    box.xOffset = this.xOffsetBox;
                if (yMirror)
                    box.yOffset = -this.yOffsetBox - this.ySizeBox;
                else
            ...
            if (!Game.SceneFreezer.stoped && this.animation != null && (this.animation.loop || this.cycles < 1)) {
                ...
                if (this.countSteps >= steps) {
                    ...
                    if (this.indexFrame >= length) {
                        this.indexFrame = this.animation.loop ? this.animation.loopStart : length - 1;
                        this.cycles += 1;
                    }
                    this.setCurrentFrame();
                }
...
(function (Game) {
    ...
    var LoadingBar = /** @class */ (function (_super) {
        ...
        function LoadingBar(y) {
            ...
            _this.sprite = new Engine.Sprite();
            _this.sprite.y = y;
            _this.sprite.setFull(true, true, Game.Resources.textureBubbles, 56, 9, -28, 0, 453, 3, 56, 9);
            return _this;
        }
        ...
        LoadingBar.prototype.onDrawDialogs = function () {
            var pepe = Math.floor(this.loadCount);
            this.full = pepe == LOAD_SIZE;
            this.sprite.setFull(true, true, Game.Resources.textureBubbles, 56, 9, -28, 0, 455, 1 + 9 * (pepe), 56, 9);
            this.sprite.render();
        };
        return LoadingBar;
    }(Engine.Entity));
...
(function (Game) {
    var TutorialA = /** @class */ (function (_super) {
        ...
        function TutorialA() {
            ...
            if (Game.IS_TOUCH)
                return _this;
            var pos = -20 - 11 - 10 + 10 + (Game.IS_TOUCH ? (Game.Level.speedrun ? 5 : 3.5) : (Game.Level.speedrun ? 0 : 0));
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = "A, D OR ARROW KEYS";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
    ...
    var TutorialB = /** @class */ (function (_super) {
        ...
        function TutorialB() {
            ...
            if (Game.IS_TOUCH)
                return _this;
            var pos = -20 - 11 - 10 + 10 + 6 - 1.5 + ((Game.Level.speedrun ? 0 : 0));
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = "W, H, SPACE OR UP ARROW";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
    ...
    var TutorialC = /** @class */ (function (_super) {
        ...
        function TutorialC() {
            ...
            if (Game.IS_TOUCH)
                return _this;
            var text0 = new Utils.FixedText();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = false;
            text0.str = "R TO RESTART";
            text0.setPos(74.5, 62);
            return _this;
        }
        return TutorialC;
    }(Engine.Entity));
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        Game.FRAMES_PLAYER = Game.FrameSelector.complex("player sprites", Game.Resources.textureBubbles, 14, 47);
        anims.stand = new Utils.Animation("stand", true, Game.FRAMES_PLAYER, 10, [1, 2, 3, 2], null);
        anims.move = new Utils.Animation("move", true, Game.FRAMES_PLAYER, 7, [2, 3, 2, 1], null);
        anims.ascend = new Utils.Animation("ascend", false, Game.FRAMES_PLAYER, 3, [4, 5], null);
        anims.fallAscend = new Utils.Animation("fall ascend", false, Game.FRAMES_PLAYER, 5, [6, 7, 8], null);
        anims.fall = new Utils.Animation("fall", false, Game.FRAMES_PLAYER, 5, [7, 8], null);
        anims.landing = new Utils.Animation("landing", false, Game.FRAMES_PLAYER, 3, [9, 10, 11, 2], null);
    });
    var Blob = /** @class */ (function (_super) {
        __extends(Blob, _super);
        function Blob(def, frames, particleClass) {
            var _this = _super.call(this, def) || this;
            ...
            _this.frames[0].applyToBox(_this.boxOverlap);
            ///this.xVelMove = VEL_MOVE;
            _this.initAnimations();
            _this.initEmitters(particleClass);
            _this.sfxJump = Game.Resources.sfxMBubJump;
            _this.sfxFall = Game.Resources.sfxMBubPop;
        ...
        Blob.prototype.initStates = function () {
            ...
            this.stateDead.onEnter = function () {
                ...
                _this.onBlobDead();
                Game.Resources.sfxMBubLose.play();
            };
        ...
        Blob.prototype.initEmitters = function (particleClass) {
            this.emitterDead = new Game.Emission.Emitter(particleClass, 8);
            this.emitterDead.sizeEmission = 4;
        };
        Blob.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.fixFrames(this.frames);
        ...
        Blob.prototype.onSetFrame = function (_animator, _animation, _frame) {
            ...
            this.frames[_animation.indexArray[_animator.indexFrame]].applyToSprite(this.sprite);
...
(function (Game) {
    var VEL = 1.3;
    var STR = 2;
    var BlobParticle = /** @class */ (function (_super) {
        __extends(BlobParticle, _super);
        function BlobParticle(emitter, frames) {
            var _this = _super.call(this, emitter) || this;
            _this.countSteps = 0;
        ...
        Object.defineProperty(BlobParticle.prototype, "xRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(BlobParticle.prototype, "yRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(BlobParticle.prototype, "xRangeVel", {
            get: function () {
        ...
        Object.defineProperty(BlobParticle.prototype, "yRangeVel", {
            get: function () {
        ...
        Object.defineProperty(BlobParticle.prototype, "xRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(BlobParticle.prototype, "yRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(BlobParticle.prototype, "rangeLife", {
            get: function () {
                return 300;
            },
            enumerable: false,
        ...
        BlobParticle.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.countSteps = BlobParticle.STEPS * STR;
        };
        BlobParticle.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.frames[STR].applyToSprite(this.sprite);
        };
        BlobParticle.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.enabled && !Game.SceneFreezer.stoped) {
                if (this.countSteps == BlobParticle.STEPS) {
                    this.frames[0].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 2) {
                    this.frames[1].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 3) {
                    this.frames[2].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 4) {
                    this.frames[3].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 5) {
                    this.frames[4].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 6) {
                    this.frames[5].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 7) {
                    this.frames[6].applyToSprite(this.sprite);
                }
                else if (this.countSteps == BlobParticle.STEPS * 8) {
                    this.frames[7].applyToSprite(this.sprite);
                }
                this.countSteps += 1;
            }
        };
        BlobParticle.STEPS = 2;
        return BlobParticle;
    }(Game.Emission.SimpleParticle));
    Game.BlobParticle = BlobParticle;
    var WhiteBlobParticle = /** @class */ (function (_super) {
        __extends(WhiteBlobParticle, _super);
        function WhiteBlobParticle(emitter) {
            return _super.call(this, emitter, Game.FRAMES_WHITE_BUBBLES_PARTICLE) || this;
        }
        return WhiteBlobParticle;
    }(BlobParticle));
    Game.WhiteBlobParticle = WhiteBlobParticle;
    var RED_FRAMES;
    Game.addAction("configure", function () {
        RED_FRAMES = Game.FrameSelector.complex("red particles", Game.Resources.textureBubbles, 382, 17);
    });
    var RedBlobParticle = /** @class */ (function (_super) {
        __extends(RedBlobParticle, _super);
        function RedBlobParticle(emitter) {
            return _super.call(this, emitter, RED_FRAMES) || this;
        }
        return RedBlobParticle;
    }(BlobParticle));
    Game.RedBlobParticle = RedBlobParticle;
})(Game || (Game = {}));
...
(function (Game) {
    var Bubble = /** @class */ (function (_super) {
        ...
        function Bubble(def, anim, particleClass, particleClass2) {
            var _this = _super.call(this, def) || this;
            _this.offAlpha = 0.2;
            _this.animator = new Utils.Animator();
            _this.startOff = _this.getProperty("start off");
            _this.animator.owner = _this.animator.listener = _this;
            _this.animator.setAnimation(anim);
            _this.sprite.enabled = true;
            anim.frames[0].applyToBox(_this.box);
            _this.box.data = _this;
            _this.emitterPop = new Game.Emission.Emitter(particleClass, 5);
            _this.emitterPop.sizeEmission = 5;
            _this.emitterRestore = new Game.Emission.Emitter(particleClass2, 5);
            _this.emitterRestore.sizeEmission = 5;
            _this.emitterRestore.box = _this.box;
            Bubble.array.push(_this);
            return _this;
        }
        Bubble.prototype.onReset = function () {
            ...
            if (this.startOff) {
                this.on = false;
                this.sprite.setRGBA(1, 1, 1, this.offAlpha);
            }
            else {
                this.on = true;
        ...
        Bubble.prototype.onStartMoveY = function () {
            Bubble.oldPlayerEnabled = Game.Player.instance.boxSolid.enabled;
            if (this.yGetMagMove() < 0) {
                this.box.enabled = this.on;
                if (this.on) {
                    Game.Player.instance.boxSolid.enabled = Game.Player.instance.boxSolid.collideAgainst(this.box, null, true, 0, true, Engine.Box.LAYER_ALL) == null;
                }
            }
        };
        Bubble.prototype.onEndMoveY = function () {
            Game.Player.instance.boxSolid.enabled = Bubble.oldPlayerEnabled;
            this.box.enabled = false;
        };
        Bubble.prototype.pop = function () {
            this.on = false;
            this.sprite.setRGBA(1, 1, 1, this.offAlpha);
            this.emitterPop.onReset();
            this.emitterPop.x = this.box.x;
            this.emitterPop.y = this.box.y;
            this.emitterPop.emittChunk();
            Game.Resources.sfxMBubPop.play();
        };
        Bubble.prototype.form = function () {
            this.on = true;
            this.sprite.setRGBA(1, 1, 1, 1);
            this.emitterRestore.onReset();
            this.emitterRestore.x = this.box.x;
            this.emitterRestore.y = this.box.y;
            this.emitterRestore.emittChunk();
            Game.Resources.sfxMBubForm.play();
        };
        Bubble.enableSolids = function () {
            for (var _i = 0, _a = Bubble.array; _i < _a.length; _i++) {
                var bubble = _a[_i];
                bubble.box.enabled = bubble.on;
            }
        };
        Bubble.disableSolids = function () {
            for (var _i = 0, _a = Bubble.array; _i < _a.length; _i++) {
                var bubble = _a[_i];
                bubble.box.enabled = false;
            }
        };
        Bubble.prototype.onSetFrame = function (_animator, _animation, frame) {
            frame.applyToSprite(this.sprite);
        };
        Bubble.prototype.onDrawObjects = function () {
        };
        Bubble.prototype.onDrawPlatforms = function () {
            this.sprite.render();
            this.box.render();
        };
    ...
    var ANIM_WHITE;
    Game.addAction("configure", function () {
        FRAMES_WHITE = Game.FrameSelector.complex("bubblewhite", Game.Resources.textureBubbles, 331, 21);
        ANIM_WHITE = new Utils.Animation("anim", true, FRAMES_WHITE, 10, [0, 1, 2, 1], null);
    });
    var WhiteBubble = /** @class */ (function (_super) {
        __extends(WhiteBubble, _super);
        function WhiteBubble(def) {
            var _this = _super.call(this, def, ANIM_WHITE, Game.WhiteExploParticle, Game.WhiteRestoreParticle) || this;
            WhiteBubble.whiteArray.push(_this);
            return _this;
        }
        WhiteBubble.formAll = function () {
            for (var _i = 0, _a = WhiteBubble.whiteArray; _i < _a.length; _i++) {
                var bubble = _a[_i];
                if (!bubble.on) {
                    bubble.form();
                }
        ...
        WhiteBubble.prototype.onClearScene = function () {
            _super.prototype.onClearScene.call(this);
            WhiteBubble.whiteArray = [];
        };
        WhiteBubble.whiteArray = [];
        return WhiteBubble;
    }(Bubble));
    Game.WhiteBubble = WhiteBubble;
    var WhiteBubbleCreator = /** @class */ (function () {
        function WhiteBubbleCreator(def) {
            def.instance.x += Game.SceneMap.instance.xSizeTile * 0.5;
            def.instance.y += Game.SceneMap.instance.ySizeTile * 0.5;
            new WhiteBubble(def);
        }
        return WhiteBubbleCreator;
    }());
    Game.WhiteBubbleCreator = WhiteBubbleCreator;
    var FRAMES_LAST;
    var ANIM_LAST;
    Game.addAction("configure", function () {
        FRAMES_LAST = Game.FrameSelector.complex("bubblelast", Game.Resources.textureBubbles, 328, 41);
        ANIM_LAST = new Utils.Animation("anim", true, FRAMES_LAST, 10, [0, 1, 2, 1], null);
    });
    var LastBubble = /** @class */ (function (_super) {
        __extends(LastBubble, _super);
        function LastBubble(def) {
            var _this = _super.call(this, def) || this;
            _this.animator = new Utils.Animator();
            _this.animator.owner = _this.animator.listener = _this;
            _this.animator.setAnimation(ANIM_LAST);
            _this.sprite.enabled = true;
            ANIM_LAST.frames[0].applyToBox(_this.box);
            _this.box.data = _this;
            return _this;
        }
        LastBubble.prototype.onSetFrame = function (_animator, _animation, frame) {
            frame.applyToSprite(this.sprite);
        };
        LastBubble.prototype.onDrawObjects = function () {
        };
        LastBubble.prototype.onDrawPlatforms = function () {
            this.sprite.render();
            this.box.render();
        };
        return LastBubble;
    }(Game.Arcade.Platformer.Platform));
    Game.LastBubble = LastBubble;
    var LastBubbleCreator = /** @class */ (function () {
        function LastBubbleCreator(def) {
            def.instance.x += Game.SceneMap.instance.xSizeTile * 0.5;
            def.instance.y += Game.SceneMap.instance.ySizeTile * 0.5;
            new LastBubble(def);
        }
        return LastBubbleCreator;
    }());
    Game.LastBubbleCreator = LastBubbleCreator;
})(Game || (Game = {}));
///<reference path="../../Engine/Entity.ts"/>
var Game;
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("dlgBtn", Game.Resources.textureBubbles, 101, 363);
    });
    var SmallButtonDialog = /** @class */ (function (_super) {
        __extends(SmallButtonDialog, _super);
        function SmallButtonDialog() {
            var _this = _super.call(this) || this;
            _this.sprite = new Engine.Sprite();
            _this.sprite.enabled = true;
            _this.sprite.pinned = true;
        ...
        SmallButtonDialog.prototype.onViewUpdate = function () {
            this.sprite.x = -Engine.Renderer.xSizeView * 0.5;
            this.sprite.y = -Engine.Renderer.ySizeView * 0.5;
        };
        SmallButtonDialog.prototype.onDrawBubblesDialog = function () {
            this.sprite.render();
        };
        return SmallButtonDialog;
    }(Engine.Entity));
    Game.SmallButtonDialog = SmallButtonDialog;
    var BigButtonDialog = /** @class */ (function (_super) {
        __extends(BigButtonDialog, _super);
        function BigButtonDialog() {
            var _this = _super.call(this) || this;
            _this.sprite = new Engine.Sprite();
            _this.sprite.enabled = true;
            _this.sprite.pinned = true;
        ...
        BigButtonDialog.prototype.onViewUpdate = function () {
            this.sprite.x = -Engine.Renderer.xSizeView * 0.5;
            this.sprite.y = -Engine.Renderer.ySizeView * 0.5;
            this.sprite.xSize = Engine.Renderer.xSizeView;
        };
        BigButtonDialog.prototype.onDrawBubblesDialog = function () {
            this.sprite.render();
        };
        return BigButtonDialog;
    }(Engine.Entity));
    Game.BigButtonDialog = BigButtonDialog;
    var SimpleBubblesDialog = /** @class */ (function (_super) {
        __extends(SimpleBubblesDialog, _super);
        function SimpleBubblesDialog(frame) {
            var _this = _super.call(this) || this;
            _this.sprite = new Engine.Sprite();
            _this.sprite.enabled = true;
            _this.sprite.pinned = true;
        ...
        SimpleBubblesDialog.prototype.onDrawBubblesDialog = function () {
            this.sprite.render();
        };
        return SimpleBubblesDialog;
    }(Engine.Entity));
    Game.SimpleBubblesDialog = SimpleBubblesDialog;
    var CreditsDialog = /** @class */ (function (_super) {
        __extends(CreditsDialog, _super);
        function CreditsDialog() {
            var _this = _super.call(this, CreditsDialog.frame) || this;
            _this.sprite.y -= _this.sprite.ySize * 0.5;
            return _this;
        }
        return CreditsDialog;
    }(SimpleBubblesDialog));
    Game.CreditsDialog = CreditsDialog;
    Game.addAction("configure", function () {
        CreditsDialog.frame = Game.FrameSelector.complex("creditsFrm", Game.Resources.textureBubbles, 253, 166)[0];
    });
    var CreditsBack = /** @class */ (function (_super) {
        __extends(CreditsBack, _super);
        function CreditsBack() {
            return _super.call(this, CreditsBack.frame) || this;
            //this.sprite.y -= this.sprite.ySize * 0.5;
        }
        return CreditsBack;
    }(SimpleBubblesDialog));
    Game.CreditsBack = CreditsBack;
    Game.addAction("configure", function () {
        CreditsBack.frame = Game.FrameSelector.complex("creditsBckBtn", Game.Resources.textureBubbles, 101, 317)[0];
    });
    var SpeedrunFrame = /** @class */ (function (_super) {
        __extends(SpeedrunFrame, _super);
        function SpeedrunFrame() {
            var _this = _super.call(this, SpeedrunFrame.frame) || this;
            _this.sprite.y -= _this.sprite.ySize * 0.5;
            return _this;
        }
    ...
    Game.addAction("configure", function () {
        SpeedrunFrame.frame = Game.FrameSelector.complex("speedrunFrame", Game.Resources.textureBubbles, 14, 362)[0];
    });
    var SpeedrunButton = /** @class */ (function (_super) {
        __extends(SpeedrunButton, _super);
        function SpeedrunButton() {
            return _super.call(this, SpeedrunButton.frame) || this;
            //this.sprite.y -= this.sprite.ySize * 0.5;
        }
        return SpeedrunButton;
    }(SimpleBubblesDialog));
    Game.SpeedrunButton = SpeedrunButton;
    Game.addAction("configure", function () {
        SpeedrunButton.frame = Game.FrameSelector.complex("speedrunButton", Game.Resources.textureBubbles, 150, 317)[0];
    });
    var LevelSelectionButton = /** @class */ (function (_super) {
        __extends(LevelSelectionButton, _super);
        function LevelSelectionButton() {
            return _super.call(this, LevelSelectionButton.frames[1]) || this;
            //this.sprite.y -= this.sprite.ySize * 0.5;
        }
        LevelSelectionButton.prototype.fix = function (index) {
            LevelSelectionButton.frames[index].applyToSprite(this.sprite);
        };
        return LevelSelectionButton;
    }(SimpleBubblesDialog));
    Game.LevelSelectionButton = LevelSelectionButton;
    Game.addAction("configure", function () {
        LevelSelectionButton.frames = Game.FrameSelector.complex("levelselecbuton", Game.Resources.textureBubbles, 101, 340);
    });
})(Game || (Game = {}));
...
(function (Game) {
    var VEL = 1.3;
    var STR = 1;
    var ExploParticle = /** @class */ (function (_super) {
        __extends(ExploParticle, _super);
        function ExploParticle(emitter, frames) {
            var _this = _super.call(this, emitter) || this;
            _this.countSteps = 0;
            _this.parentRelative = false;
            _this.frames = frames;
        ...
        Object.defineProperty(ExploParticle.prototype, "xRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(ExploParticle.prototype, "yRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(ExploParticle.prototype, "xRangeVel", {
            /*
            protected get xRangeVel(){
                if(this.index == 0 || this.index == 1){
                    return VEL;
                }
                else{
        ...
        Object.defineProperty(ExploParticle.prototype, "yRangeVel", {
            get: function () {
                if (this.index == 0)
                    return 0;
                if (this.index == 3)
        ...
        Object.defineProperty(ExploParticle.prototype, "xRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(ExploParticle.prototype, "yRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(ExploParticle.prototype, "rangeLife", {
            get: function () {
                return 300;
            },
            enumerable: false,
        ...
        ExploParticle.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.countSteps = ExploParticle.STEPS * STR;
        };
        ExploParticle.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.frames[STR].applyToSprite(this.sprite);
        };
        ExploParticle.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.enabled && !Game.SceneFreezer.stoped) {
                if (this.countSteps == ExploParticle.STEPS) {
                    this.frames[0].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 2) {
                    this.frames[1].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 3) {
                    this.frames[2].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 4) {
                    this.frames[3].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 5) {
                    this.frames[4].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 6) {
                    this.frames[5].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 7) {
                    this.frames[6].applyToSprite(this.sprite);
                }
                else if (this.countSteps == ExploParticle.STEPS * 8) {
                    this.frames[7].applyToSprite(this.sprite);
                }
                this.countSteps += 1;
            }
        };
        ExploParticle.STEPS = 2;
        return ExploParticle;
    }(Game.Emission.SimpleParticle));
    Game.ExploParticle = ExploParticle;
    var WhiteExploParticle = /** @class */ (function (_super) {
        __extends(WhiteExploParticle, _super);
        function WhiteExploParticle(emitter) {
            return _super.call(this, emitter, Game.FRAMES_WHITE_BUBBLES_PARTICLE) || this;
        }
        return WhiteExploParticle;
    }(ExploParticle));
    Game.WhiteExploParticle = WhiteExploParticle;
})(Game || (Game = {}));
var Game;
(function (Game) {
    Game.addAction("configure", function () {
        Game.FRAMES_WHITE_BUBBLES_PARTICLE = Game.FrameSelector.complex("goal particles", Game.Resources.textureBubbles, 382, 1);
    });
    var VEL = 1.1;
    var GoalParticle = /** @class */ (function (_super) {
        ...
        GoalParticle.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.countSteps = GoalParticle.STEPS * 1;
        };
        GoalParticle.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            Game.FRAMES_WHITE_BUBBLES_PARTICLE[0].applyToSprite(this.sprite);
        };
        GoalParticle.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.enabled && !Game.SceneFreezer.stoped) {
                if (this.countSteps == GoalParticle.STEPS) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[0].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 2) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[1].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 3) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[2].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 4) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[3].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 5) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[4].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 6) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[5].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 7) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[6].applyToSprite(this.sprite);
                }
                else if (this.countSteps == GoalParticle.STEPS * 8) {
                    Game.FRAMES_WHITE_BUBBLES_PARTICLE[7].applyToSprite(this.sprite);
                }
                this.countSteps += 1;
            }
        };
        GoalParticle.STEPS = 2;
        return GoalParticle;
    }(Game.Emission.SimpleParticle));
...
(function (Game) {
    var FRAMES_HRZ;
    var ANIM_STAND_HRZ;
    var ANIM_CHARGING_HRZ;
    var ANIM_SHOOTING_HRZ;
    var ANIM_RELEASING_HRZ;
    var ANIM_LIGHT_STAND_HRZ;
    var ANIM_LIGHT_CHARGING_HRZ;
    var ANIM_LIGHT_SHOOTING_HRZ;
    var ANIM_LIGHT_RELEASING_HRZ;
    var FRAMES_VRT;
    var ANIM_STAND_VRT;
    var ANIM_CHARGING_VRT;
    var ANIM_SHOOTING_VRT;
    var ANIM_RELEASING_VRT;
    var ANIM_LIGHT_STAND_VRT;
    var ANIM_LIGHT_CHARGING_VRT;
    var ANIM_LIGHT_SHOOTING_VRT;
    var ANIM_LIGHT_RELEASING_VRT;
    Game.addAction("configure", function () {
        FRAMES_HRZ = Game.FrameSelector.complex("laserhorz", Game.Resources.textureBubbles, 14, 100);
        ANIM_STAND_HRZ = new Utils.Animation("stand", true, FRAMES_HRZ, 12, [2, 3, 4, 3], null);
        ANIM_CHARGING_HRZ = new Utils.Animation("charging", true, FRAMES_HRZ, 2, [2, 3, 4, 3], null);
        ANIM_SHOOTING_HRZ = new Utils.Animation("shooting", true, FRAMES_HRZ, 1, [2, 3, 4, 3], null);
        ANIM_RELEASING_HRZ = new Utils.Animation("releasing", true, FRAMES_HRZ, 6, [2, 3, 4, 3], null);
        ANIM_LIGHT_STAND_HRZ = new Utils.Animation("stand", true, FRAMES_HRZ, 12, [5, 5], null);
        ANIM_LIGHT_CHARGING_HRZ = new Utils.Animation("charging", true, FRAMES_HRZ, 1, [8, 9], null);
        ANIM_LIGHT_SHOOTING_HRZ = new Utils.Animation("shooting", true, FRAMES_HRZ, 1, [16, 17, 18, 19, 18], null, 3);
        ANIM_LIGHT_RELEASING_HRZ = new Utils.Animation("releasing", false, FRAMES_HRZ, 1, [12, 11, 10, 9, 8, 5], null);
        FRAMES_VRT = Game.FrameSelector.complex("laservert", Game.Resources.textureBubbles, 14, 81);
        ANIM_STAND_VRT = new Utils.Animation("stand", true, FRAMES_VRT, 12, [2, 3, 4, 3], null);
        ANIM_CHARGING_VRT = new Utils.Animation("charging", true, FRAMES_VRT, 2, [2, 3, 4, 3], null);
        ANIM_SHOOTING_VRT = new Utils.Animation("shooting", true, FRAMES_VRT, 1, [2, 3, 4, 3], null);
        ANIM_RELEASING_VRT = new Utils.Animation("releasing", true, FRAMES_VRT, 6, [2, 3, 4, 3], null);
        ANIM_LIGHT_STAND_VRT = new Utils.Animation("stand", true, FRAMES_VRT, 12, [5, 5], null);
        ANIM_LIGHT_CHARGING_VRT = new Utils.Animation("charging", true, FRAMES_VRT, 1, [8, 9], null);
        ANIM_LIGHT_SHOOTING_VRT = new Utils.Animation("shooting", true, FRAMES_VRT, 1, [16, 17, 18, 19, 18], null, 3);
        ANIM_LIGHT_RELEASING_VRT = new Utils.Animation("releasing", false, FRAMES_VRT, 1, [12, 11, 10, 9, 8, 5], null);
    });
    var Laser = /** @class */ (function (_super) {
        ...
        function Laser(def) {
            ...
            _this.boxHead = new Engine.Box();
            _this.boxHead.enabled = true;
            _this.boxHead.renderable = true;
            _this.boxLight = new Engine.Box();
            _this.boxLight.enabled = true;
            _this.boxLight.renderable = true;
            _this.head = new Engine.Sprite();
            _this.head.enabled = true;
            _this.light = new Engine.Sprite();
            _this.light.enabled = true;
            _this.animatorLight = new Utils.Animator();
            _this.animatorLight.owner = _this;
            _this.animatorLight.listener = _this;
            _this.stepsStart = _this.getProperty("steps start");
            _this.stepsWait = _this.getProperty("steps wait");
            _this.stepsCharging = _this.getProperty("steps charging");
            _this.stepsShoot = _this.getProperty("steps shoot");
            _this.horizontal = _this.getProperty("horizontal");
            if (_this.horizontal) {
                _this.animStand = ANIM_STAND_HRZ;
                _this.animCharging = ANIM_CHARGING_HRZ;
                _this.animShooting = ANIM_SHOOTING_HRZ;
                _this.animReleasing = ANIM_RELEASING_HRZ;
                _this.animLightStand = ANIM_LIGHT_STAND_HRZ;
                _this.animLightCharging = ANIM_LIGHT_CHARGING_HRZ;
                _this.animLightShooting = ANIM_LIGHT_SHOOTING_HRZ;
                _this.animLightReleasing = ANIM_LIGHT_RELEASING_HRZ;
                FRAMES_HRZ[0].applyToSprite(_this.sprite);
                FRAMES_HRZ[0].applyToBox(_this.boxSolid);
                _this.xAlign = "start";
                _this.yAlign = "middle";
                if (_this.def.flip.x) {
                    _this.head.xMirror = true;
                    _this.light.xMirror = true;
                    _this.def.instance.x -= (_this.boxSolid.xSize - 2);
                    _this.sprite.xOffset -= (_this.boxSolid.xSize - 2);
                    _this.xOffHead = -1;
                    _this.yOffHead = 0;
                    _this.xOffLight = 0;
                    _this.yOffLight = 0;
                ...
                _this.animStand = ANIM_STAND_VRT;
                _this.animCharging = ANIM_CHARGING_VRT;
                _this.animShooting = ANIM_SHOOTING_VRT;
                _this.animReleasing = ANIM_RELEASING_VRT;
                _this.animLightStand = ANIM_LIGHT_STAND_VRT;
                _this.animLightCharging = ANIM_LIGHT_CHARGING_VRT;
                _this.animLightShooting = ANIM_LIGHT_SHOOTING_VRT;
                _this.animLightReleasing = ANIM_LIGHT_RELEASING_VRT;
                FRAMES_VRT[0].applyToSprite(_this.sprite);
                FRAMES_VRT[0].applyToBox(_this.boxSolid);
                _this.yAlign = "start";
                if (_this.def.flip.y) {
                    _this.head.yMirror = true;
                    _this.light.yMirror = true;
                    _this.def.instance.y -= (_this.boxSolid.ySize - 2);
                    _this.sprite.yOffset -= (_this.boxSolid.ySize - 2);
                    _this.xOffHead = 0;
                    _this.yOffHead = -1;
                    _this.xOffLight = 0;
                    _this.yOffLight = 0;
            ...
            Game.SceneMap.instance.boxesEnemies.push(_this.boxHead);
            Game.SceneMap.instance.boxesEnemies.push(_this.boxLight);
            return _this;
        }
        Laser.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.boxHead.x = this.boxSolid.x + this.xOffHead;
            this.boxHead.y = this.boxSolid.y + this.yOffHead;
            this.boxLight.enabled = false;
            this.animator.setAnimation(this.animStand);
            this.setLaserStateStand();
            this.count = this.stepsStart;
            this.fixLaserSize();
        };
        Laser.prototype.setLaserStateStand = function () {
            this.count = this.stepsWait;
            this.animator.setAnimation(this.animStand, true);
            this.animatorLight.setAnimation(this.animLightStand);
            this.laserState = 0;
        };
        Laser.prototype.fixLaserSize = function () {
            if (this.horizontal) {
                this.boxLight.x = this.boxSolid.x + this.xOffLight;
                this.boxLight.y = this.boxSolid.y + this.yOffLight;
                this.boxLight.ySize = 4;
                this.boxLight.yOffset = -2;
                if (this.sprite.xMirror) {
                    var hits = this.boxSolid.cast(Game.SceneMap.instance.boxesSolids, null, true, -Game.SceneMap.instance.xSizeMap, true, Engine.Box.LAYER_ALL);
                    if (hits == null) {
                        this.light.xScale = -Game.SceneMap.instance.xSizeMap;
                        this.boxLight.xSize = -Game.SceneMap.instance.xSizeMap;
                        this.boxLight.xOffset = Game.SceneMap.instance.xSizeMap;
                    }
                    else {
                        this.light.xScale = -((hits[0].distance / Engine.Box.UNIT) - 1);
                        this.boxLight.xSize = -(hits[0].distance / Engine.Box.UNIT) - 1;
                        this.boxLight.xOffset = (hits[0].distance / Engine.Box.UNIT) - 1;
                    }
                }
                else {
                    var hits = this.boxSolid.cast(Game.SceneMap.instance.boxesSolids, null, true, Game.SceneMap.instance.xSizeMap, true, Engine.Box.LAYER_ALL);
                    if (hits == null) {
                        ...
                        this.light.xScale = (hits[0].distance / Engine.Box.UNIT) + this.boxSolid.xSize - 1;
                        this.boxLight.xSize = (hits[0].distance / Engine.Box.UNIT) + this.boxSolid.xSize - 1;
                    }
                }
            }
            else {
                this.boxLight.x = this.boxSolid.x + this.xOffLight;
                this.boxLight.y = this.boxSolid.y + this.yOffLight;
                this.boxLight.xSize = 4;
                this.boxLight.xOffset = -2;
                if (this.sprite.yMirror) {
                    var hits = this.boxSolid.cast(Game.SceneMap.instance.boxesSolids, null, false, -Game.SceneMap.instance.ySizeMap, true, Engine.Box.LAYER_ALL);
                    if (hits == null) {
                        this.light.yScale = -Game.SceneMap.instance.ySizeMap;
                        this.boxLight.ySize = -Game.SceneMap.instance.ySizeMap;
                        this.boxLight.yOffset = Game.SceneMap.instance.ySizeMap;
                    }
                    else {
                        this.light.yScale = -((hits[0].distance / Engine.Box.UNIT) - 1);
                        this.boxLight.ySize = -(hits[0].distance / Engine.Box.UNIT) - 1;
                        this.boxLight.yOffset = (hits[0].distance / Engine.Box.UNIT) - 1;
                    }
                }
                else {
                    var hits = this.boxSolid.cast(Game.SceneMap.instance.boxesSolids, null, false, Game.SceneMap.instance.ySizeMap, true, Engine.Box.LAYER_ALL);
                    if (hits == null) {
                        ...
                        this.light.yScale = (hits[0].distance / Engine.Box.UNIT) + this.boxSolid.ySize - 1;
                        this.boxLight.ySize = (hits[0].distance / Engine.Box.UNIT) + this.boxSolid.ySize - 1;
                    }
                }
            }
        };
        Laser.prototype.onMoveUpdate = function () {
            _super.prototype.onMoveUpdate.call(this);
        };
        Laser.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped)
                return;
            this.fixLaserSize();
            switch (this.laserState) {
                case 0:
                    if (this.count == 0) {
                        this.count = this.stepsCharging;
                        this.animator.setAnimation(this.animCharging, true);
                        this.animatorLight.setAnimation(this.animLightCharging);
                        this.laserState = 1;
                    }
                    else {
                        this.count--;
                ...
                case 1:
                    if (this.count == 0) {
                        Game.Resources.sfxMBubLaser.play();
                        this.count = this.stepsShoot;
                        this.boxLight.enabled = true;
                        this.animator.setAnimation(this.animShooting, true);
                        this.animatorLight.setAnimation(this.animLightShooting);
                        this.laserState = 2;
                    }
                    else {
                        this.count--;
                ...
                case 2:
                    if (this.count == 0) {
                        this.boxLight.enabled = false;
                        this.animator.setAnimation(this.animReleasing, true);
                        this.animatorLight.setAnimation(this.animLightReleasing);
                        this.laserState = 3;
                    }
                    else {
                        this.count--;
        ...
        Laser.prototype.xMoveOnPlatform = function (_dist) {
            this.boxSolid.x += _dist;
            this.boxHead.x = this.boxSolid.x + this.xOffHead;
            this.boxLight.x = this.boxSolid.x + this.xOffLight;
        };
        Laser.prototype.yMoveOnPlatform = function (_dist) {
            this.boxSolid.y += _dist;
            this.boxHead.y = this.boxSolid.y + this.yOffHead;
            this.boxLight.y = this.boxSolid.y + this.yOffLight;
        };
        Laser.prototype.onPlatformOverlapX = function () {
        };
        Laser.prototype.onPlatformOverlapY = function () {
        };
        Laser.prototype.onDrawObjectsBack = function () {
            ...
            this.head.x = this.sprite.x + this.xOffHead;
            this.head.y = this.sprite.y + this.yOffHead;
            this.light.x = this.sprite.x + this.xOffLight;
            this.light.y = this.sprite.y + this.yOffLight;
            this.light.render();
            this.head.render();
            this.sprite.render();
            if (Engine.Box.debugRender) {
                ...
                this.boxHead.render();
                this.boxLight.render();
            }
        };
        Laser.prototype.onSetFrame = function (_animator, _animation, _frame) {
            if (_animator == this.animator) {
                _frame.applyToSprite(this.head);
                _frame.applyToBox(this.boxHead, this.sprite.xMirror, this.sprite.yMirror);
            }
            else {
                _frame.applyToSprite(this.light);
            }
        };
        return Laser;
...
var Game;
(function (Game) {
    var PATROLLER_FRAMES;
    Game.addAction("configure", function () {
        PATROLLER_FRAMES = Game.FrameSelector.complex("patroller sprites", Game.Resources.textureBubbles, 14, 64);
    });
    var Patroller = /** @class */ (function (_super) {
        __extends(Patroller, _super);
        function Patroller(def) {
            var _this = _super.call(this, def, PATROLLER_FRAMES, Game.RedBlobParticle) || this;
            _this.flipOnAbyss = true;
            _this.flipOnWall = true;
...
(function (Game) {
    var DEFAULT_STEPS_WAIT_WINNING_LOSSING = 26;
    var VEL_JUMP_NORMAL = 2.35;
    var VEL_JUMP_POP = 2.95;
    var Player = /** @class */ (function (_super) {
        __extends(Player, _super);
        function Player(def) {
            var _this = _super.call(this, def, Game.FRAMES_PLAYER, Game.WhiteBlobParticle) || this;
            _this.stepsWin = DEFAULT_STEPS_WAIT_WINNING_LOSSING;
            _this.stepsLoss = DEFAULT_STEPS_WAIT_WINNING_LOSSING;
            _this._canWin = true;
            _this._canLoss = true;
        ...
        Object.defineProperty(Player.prototype, "jumpControlPressed", {
            get: function () {
                return !this.title && this.control.pressedDelayedAction;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(Player.prototype, "jumpControlDown", {
            get: function () {
                return !this.title && this.control.downAction;
            },
            enumerable: false,
            configurable: true
        });
        ...
        */
        Player.prototype.initStates = function () {
            ...
            this.stateAscendPop = new Game.Flow.State(this, "ascendpop");
            this.stateAscendPop.onEnter = function () {
                _this.yVel = -VEL_JUMP_POP;
                _this.pop = false;
            };
            this.stateAscendPop.addLink(this.stateAscend, function () { return true; });
            this.stateStand.addLink(this.stateAscendPop, function () { return _this.pop; });
            this.stateMove.addLink(this.stateAscendPop, function () { return _this.pop; });
            this.stateAscend.addLink(this.stateAscendPop, function () { return _this.pop; });
            this.stateFall.addLink(this.stateAscendPop, function () { return _this.pop; });
            this.stateLanding.addLink(this.stateAscendPop, function () { return _this.pop; });
            return iniState;
        };
            ...
            if (!Game.SceneFreezer.stoped) {
                ...
                if (this.yDirContact > 0) {
                    for (var _i = 0, _a = this.yContacts; _i < _a.length; _i++) {
                        var contact = _a[_i];
                        if (contact.other.data instanceof Game.Bubble) {
                            contact.other.data.pop();
                            this.pop = true;
                            return;
                        }
                    }
                    Game.WhiteBubble.formAll();
                }
            }
        };
        ...
        Player.prototype.onStartMoveY = function (dist) {
            if (dist > 0) {
                Game.Bubble.enableSolids();
            }
        };
        Player.prototype.onEndMoveY = function () {
            Game.Bubble.disableSolids();
        };
        Player.prototype.onStartMoveOnPlatformY = function (dist) {
            this.onStartMoveY(dist);
        };
        Player.prototype.onEndMoveOnPlatformY = function () {
            Game.Bubble.disableSolids();
        };
        Player.prototype.onStartPlatformCheckY = function () {
            Game.Bubble.enableSolids();
        };
        Player.prototype.onEndPlatformCheckY = function () {
            Game.Bubble.disableSolids();
        };
        ...
        Object.defineProperty(Player.prototype, "winCondition", {
            get: function () {
                return Game.Goal.count > 0 && Game.Goal.got == Game.Goal.count;
            },
            enumerable: false,
            configurable: true
        });
...
(function (Game) {
    ...
    var STR = 1;
    var DIST = 10;
    var RestoreParticle = /** @class */ (function (_super) {
        __extends(RestoreParticle, _super);
        function RestoreParticle(emitter, frames) {
            var _this = _super.call(this, emitter) || this;
            _this.countSteps = 0;
            _this.parentRelative = true;
            _this.frames = frames;
            return _this;
        }
        Object.defineProperty(RestoreParticle.prototype, "xRange", {
            get: function () {
                if (this.index == 0 || this.index == 1) {
                    return DIST;
                }
        ...
        Object.defineProperty(RestoreParticle.prototype, "yRange", {
            get: function () {
                if (this.index == 0 || this.index == 2) {
                    return DIST;
                }
        ...
        Object.defineProperty(RestoreParticle.prototype, "xRangeVel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(RestoreParticle.prototype, "yRangeVel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(RestoreParticle.prototype, "xRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(RestoreParticle.prototype, "yRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(RestoreParticle.prototype, "rangeLife", {
            get: function () {
                return 300;
            },
            enumerable: false,
        ...
        RestoreParticle.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.countSteps = RestoreParticle.STEPS * STR;
        };
        RestoreParticle.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.frames[STR].applyToSprite(this.sprite);
        };
        RestoreParticle.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.enabled && !Game.SceneFreezer.stoped) {
                if (this.countSteps == RestoreParticle.STEPS) {
                    this.frames[0].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 2) {
                    this.frames[1].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 3) {
                    this.frames[2].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 4) {
                    this.frames[3].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 5) {
                    this.frames[4].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 6) {
                    this.frames[5].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 7) {
                    this.frames[6].applyToSprite(this.sprite);
                }
                else if (this.countSteps == RestoreParticle.STEPS * 8) {
                    this.frames[7].applyToSprite(this.sprite);
                }
                this.countSteps += 1;
                var xDir = this.emitter.box.x - this.x;
                var yDir = this.emitter.box.y - this.y;
                var mag = Math.sqrt(xDir * xDir + yDir * yDir);
                xDir /= mag;
                yDir /= mag;
                this.x += xDir * VEL;
                this.y += yDir * VEL;
        ...
        RestoreParticle.STEPS = 2;
        return RestoreParticle;
    }(Game.Emission.SimpleParticle));
    Game.RestoreParticle = RestoreParticle;
    var WhiteRestoreParticle = /** @class */ (function (_super) {
        __extends(WhiteRestoreParticle, _super);
        function WhiteRestoreParticle(emitter) {
            return _super.call(this, emitter, Game.FRAMES_WHITE_BUBBLES_PARTICLE) || this;
        }
        return WhiteRestoreParticle;
    }(RestoreParticle));
    Game.WhiteRestoreParticle = WhiteRestoreParticle;
})(Game || (Game = {}));
///<reference path = "../../Game/Arcade/WorldEntity.ts"/>
var Game;
(function (Game) {
    ...
    var ANIM_180;
    Game.addAction("configure", function () {
        FRAME_BOX_SOLID_180 = Game.FrameSelector.complex("spike 180 solid", Game.Resources.textureBubbles, 205, 293);
        FRAMES_BOXES_DAMAGE_180 = Game.FrameSelector.complex("spike 180 damage", Game.Resources.textureBubbles, 205, 293);
        FRAMES_ANIM_180 = Game.FrameSelector.complex("spike 180 anim", Game.Resources.textureBubbles, 205, 293);
    ...
    var ANIM_360;
    Game.addAction("configure", function () {
        FRAME_BOX_SOLID_360 = Game.FrameSelector.complex("spike 360 solid", Game.Resources.textureBubbles, 222, 293);
        FRAMES_BOXES_DAMAGE_360 = Game.FrameSelector.complex("spike 360 damage", Game.Resources.textureBubbles, 222, 293);
        FRAMES_ANIM_360 = Game.FrameSelector.complex("spike 360 anim", Game.Resources.textureBubbles, 222, 293);
    ...
    var ANIM_90;
    Game.addAction("configure", function () {
        FRAME_BOX_SOLID_90 = Game.FrameSelector.complex("spike 90 solid", Game.Resources.textureBubbles, 222, 310);
        FRAMES_BOXES_DAMAGE_90 = Game.FrameSelector.complex("spike 90 damage", Game.Resources.textureBubbles, 222, 310);
        FRAMES_ANIM_90 = Game.FrameSelector.complex("spike 90 anim", Game.Resources.textureBubbles, 222, 310);
    ...
    var ANIM_270;
    Game.addAction("configure", function () {
        FRAME_BOX_SOLID_270 = Game.FrameSelector.complex("spike 270 solid", Game.Resources.textureBubbles, 205, 310);
        FRAMES_BOXES_DAMAGE_270 = Game.FrameSelector.complex("spike 270 damage", Game.Resources.textureBubbles, 205, 310);
        FRAMES_ANIM_270 = Game.FrameSelector.complex("spike 270 anim", Game.Resources.textureBubbles, 205, 310);
...
(function (Game) {
    ...
    var ANIM;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("goal", Game.Resources.textureBubbles, 313, 1);
        ANIM = new Utils.Animation("goal", true, FRAMES, 10, [0, 1, 2, 1], null);
    });
    var Goal = /** @class */ (function (_super) {
        __extends(Goal, _super);
        function Goal(def) {
        ...
        Goal.prototype.onOverlapUpdate = function () {
            if (!Game.SceneFreezer.stoped) {
                ...
                if (this.boxSolid.collideAgainst(Game.Player.instance.boxSolid, null, true, 0, false, Engine.Box.LAYER_ALL) != null) {
                    ...
                    this.animator.setCurrentFrame();
                    Game.Resources.sfxMBubWin.play();
                    Goal.got++;
                }
            }
        };
...
(function (Game) {
    ...
    var Roller = /** @class */ (function (_super) {
        ...
        Roller.prototype.onStart = function () {
            ...
            var contacts = this.boxSolid.collide(Game.SceneMap.instance.boxesSolids, null, true, -1, true, Engine.Box.LAYER_ALL);
            if (contacts != null) {
                for (var _a = 0, contacts_4 = contacts; _a < contacts_4.length; _a++) {
                    var contact = contacts_4[_a];
                    if (contact.other.data instanceof Game.Arcade.Platformer.Platform) {
                        contact.other.data.addChild(this);
                        return;
                    }
            ...
            if (contacts != null) {
                for (var _b = 0, contacts_5 = contacts; _b < contacts_5.length; _b++) {
                    var contact = contacts_5[_b];
                    if (contact.other.data instanceof Game.Arcade.Platformer.Platform) {
                        contact.other.data.addChild(this);
                        return;
                    }
            ...
            var contacts = this.boxSolid.collide(Game.SceneMap.instance.boxesSolids, null, false, -1, true, Engine.Box.LAYER_ALL);
            if (contacts != null) {
                for (var _c = 0, contacts_6 = contacts; _c < contacts_6.length; _c++) {
                    var contact = contacts_6[_c];
                    if (contact.other.data instanceof Game.Arcade.Platformer.Platform) {
                        contact.other.data.addChild(this);
                        return;
                    }
