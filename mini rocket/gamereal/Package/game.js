...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "noa", "minirocket", "1_0");
        }
        else {
            Engine.Data.setID("c", "n", "minrocket", "1_0");
        }
        ...
        */
        ...
        SceneMap.prototype.onDrawSceneSky = function () {
            for (var _i = 0, _a = this.spritesBack; _i < _a.length; _i++) {
                var sprite = _a[_i];
                sprite.renderAt(sprite.x, sprite.y + Game.camoff);
            }
        };
...
(function (Game) {
    ...
    var LastScene = /** @class */ (function (_super) {
        ...
        function LastScene() {
            ...
            var pepe = -32 + 2 + 4 + 1 + 1 - 8 + 0.5 + 2 + 4 - 2 - (Game.IS_TOUCH ? 4 * 1 - 1 : 0);
            //Level.speedrun=true;
            ...
            */
            ...
            exi.anchor.yAligned = pepe + 12 + 12 - 6 + 1 - 0.5 + 2 - 1 - 0.5 + 1 - 2 + 1 + (Game.IS_TOUCH ? -1 * 1 + 1 : 1);
            ...
            Game.camoff = -(Game.IS_TOUCH ? 5 - 5 + 2 : 8 * 2 - 4 + 1.0);
            Game.Background.mak();
        ...
        LastScene.prototype.onDrawSceneSky = function () {
            if (!Game.Background.spr.enabled) {
                _super.prototype.onDrawSceneSky.call(this);
            }
        };
        LastScene.prototype.onTimeUpdateSceneBeforeDrawFixed = function () {
            var x = this.xSizeMap * 0.5;
            var y = this.ySizeMap * 0.5 + Game.camoff;
...
(function (Game) {
    ...
    (function (maimen) {
        ...
        function onTimeUpdate() {
            Engine.Renderer.camera(Game.SceneMap.instance.xSizeMap * 0.5 /*+LevelShake.position+LevelShake2.position*/, Game.SceneMap.instance.ySizeMap * 0.5);
            if (maimen.blomorlin) {
...
(function (Game) {
    ...
    var Level = /** @class */ (function (_super) {
        ...
        function Level() {
            ...
            //SceneColors.instance.fillDown.setRGBA(0, 0, 0, 1);
        ...
        Level.prototype.onTimeUpdateSceneBeforeDrawFixed = function () {
            ...
            Engine.Renderer.camera((x + Game.LevelShake.position + Game.LevelShake2.position), (y) + Game.camoff);
        };
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        ...
        Resources.bgms[0].customStart = 0;
        Resources.bgms[0].loopStart = 0;
        Resources.bgms[0].loopEnd = 135.9999;
        ...
        Resources.sfx[0].volume = 1.35 * volumeScale * sfxsca;
        Resources.sfx[1].volume = 1.40 * volumeScale * sfxsca;
        Resources.sfx[2].volume = 1.45 * volumeScale * sfxsca;
        Resources.sfx[3].volume = 1.20 * volumeScale * sfxsca;
...
(function (Game) {
    ...
    (function (Background) {
        ...
        function mak(level) {
            ...
            if (level) {
                switch (Game.Level.index) {
                    ...
                    case 26:
                    case 27:
                        Background.spr.enabled = false;
                        Game.SceneColors.enabledDown = true;
                        Game.SceneColors.instance.usingFill = true;
                        break;
                    default:
                        Background.spr.enabled = true;
                        Game.SceneColors.enabledDown = false;
                        Game.SceneColors.instance.usingFill = false;
                        break;
                }
            }
            else if (Game.LastScene.instance != null) {
                Background.spr.enabled = false;
                Game.SceneColors.enabledDown = false;
                Game.SceneColors.instance.usingFill = false;
            }
        ...
        Background.onReset = onReset;
        function onViewUpdate() {
            if (Engine.Renderer.xSizeView > Engine.Renderer.ySizeView) {
                Background.spr.setFull(Background.spr.enabled, false, Game.Resources.texgam, 320, 120 + 16, 0, 0, 304, 440, 320, 120 + 16);
            }
            else {
                Background.spr.setFull(Background.spr.enabled, false, Game.Resources.texgam, 160 + 16, 240, 0, 0, 304, 440, 160 + 16, 240);
            }
        }
        ...
        function onDrawSceneSky() {
            ...
            Background.spr.y = Background.spr.ySize + Game.camoff;
...
(function (Game) {
    ...
    (function (goa) {
        goa.ani = [];
        Game.addAction("configure", function () {
            goa.fra = Game.FrameSelector.complex("coi", Game.Resources.texgam, 0, 986);
        ...
        function ovegot() {
            for (var i = 0; i < goa.cou; i++) {
                if (goa.box[i].enabled && goa.box[i].collideAgainst(Game.pla.box)) {
                    ...
                    gotcou++;
                    if (gotcou == goa.cou) {
                        Game.Resources.sfx[1].extraGain.gain.value = 0;
                        Game.Resources.sfx[2].play();
                    }
                    else if (soucou < 0) {
                        Game.Resources.sfx[1].extraGain.gain.value = 1;
...
(function (Game) {
    ...
    (function (goa) {
        ...
        var FRAMES_GOAL;
        Game.addAction("configure", function () {
            FRAMES_GOAL = Game.FrameSelector.complex("goal particles", Game.Resources.texgam, 0, 956);
        });
...
(function (Game) {
    ...
    (function (FloorPatroller) {
        ...
        function mak(_df) {
            ...
            FloorPatroller.def[FloorPatroller.cou].flip = {};
            FloorPatroller.def[FloorPatroller.cou].flip.x = Game.flilev ? !getpro(FloorPatroller.cou, "horfli") : getpro(FloorPatroller.cou, "horfli");
            FloorPatroller.def[FloorPatroller.cou].flip.y = getpro(FloorPatroller.cou, "verfli");
...
(function (Game) {
    var FloorPatroller;
    (function (FloorPatroller) {
        Game.addAction("preconfigure", function () { FloorPatroller.fra = Game.FrameSelector.complex("flopat", Game.Resources.texgam, 0, 969); });
        FloorPatroller.spr = [];
        function conspr(i) {
...
(function (Game) {
    ...
    (function (pla) {
        ...
        function movcam() {
            //horcam=box.x;
            //vercam=box.y-box.ySize*0.5;
        }
        pla.movcam = movcam;
        function timcam() {
            //horcam=ext.x;
            //vercam=ext.y-box.ySize*0.5;
        }
        pla.timcam = timcam;
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
...
(function (Game) {
    ...
    (function (pla) {
        pla.mov = false;
        function condef() {
            pla.wal = pla.getpro("wal");
            pla.horfli = Game.flilev ? !pla.getpro("horfli") : pla.getpro("horfli");
            pla.verfli = pla.getpro("verfli");
            pla.mov = pla.getpro("mov");
            pla.def.instance.x += Game.SceneMap.instance.xSizeTile * 0.5;
            pla.def.instance.y += pla.verfli ? -Game.SceneMap.instance.ySizeTile + pla.box.ySize : 0;
        }
        pla.condef = condef;
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
...
(function (Game) {
    ...
    (function (pla) {
        ...
        var FRAMES_GOAL;
        Game.addAction("configure", function () {
            FRAMES_GOAL = Game.FrameSelector.complex("dead particles", Game.Resources.texgam, 0, 956);
        });
...
(function (Game) {
    ...
    (function (pla) {
        ...
        function movphy() {
            ...
            pla.verhit = pla.box.cast(Game.SceneMap.instance.boxesSolids, null, false, pla.vervel, pla.vervel != 0, Engine.Box.LAYER_ALL);
            pla.box.translate(pla.verhit, false, pla.vervel, true);
            pla.verhitdir = pla.verhit == null ? 0 : (pla.vervel < 0 ? -1 : 1);
            //console.log(horvel+" "+horhitdir+" "+vervel+" "+verhitdir);
        }
        pla.movphy = movphy;
        function timphy() {
...
(function (Game) {
    ...
    (function (pla_1) {
        ...
        function movpla() {
            var nexpla = null;
            var con = pla_1.horhit == null ? pla_1.verhit : pla_1.horhit;
            if (con != null) {
...
(function (Game) {
    ...
    (function (pla) {
        Game.addAction("preinit", function () {
            pla.fra = Game.FrameSelector.complex("Player", Game.Resources.texgam, 0, 1002);
        });
        ...
        function linsta() {
            switch (pla.sta) {
                ...
                case pla.stafal:
                    ...
                    break;
                /*
                case staasc:linasc();break;
                
                
                case stajum:linjum();break;
                case stalan:linlan();break;
                case stastu:linstu();break;
                case stawal:linwal();break;
                */
            }
        }
        pla.linsta = linsta;
        function stesta() {
            switch (pla.sta) {
                ...
                case pla.stalos:
                    ...
                    break;
                /*
                case stajum:stejum();break;
                
                case stastu:stestu();break;
                */
            }
        }
        pla.stesta = stesta;
...
(function (Game) {
    ...
    (function (pla) {
        var cli;
        Game.addAction("init", function () {
            cli = new Utils.Animation("fal", false, pla.fra, 2, [0, 1, 2], null);
        });
        function entfal() {
            //return false;
            //console.log(horhitdir+" "+verhitdir);
            if (pla.horhitdir == 0 && pla.verhitdir == 0) {
                pla.ani.off = 24;
                if (pla.vervel > 0)
                    pla.ani.off += 0;
        ...
        pla.entfal = entfal;
        function stefal() {
            pla.horvel += pla.gra * Game.dir(pla.horvel);
            if (Math.abs(pla.horvel) > pla.maxvervel) {
                pla.horvel = Game.dir(pla.horvel) * pla.maxvervel;
            }
            pla.vervel += pla.gra * Game.dir(pla.vervel);
            if (Math.abs(pla.vervel) > pla.maxvervel) {
                pla.vervel = Game.dir(pla.vervel) * pla.maxvervel;
            }
        }
        pla.stefal = stefal;
        function linfal() {
...
(function (Game) {
    ...
    (function (pla) {
        ...
        var clilan;
        Game.addAction("init", function () {
            cliidl = clilan = new Utils.Animation("idl", true, pla.fra, 10, [0, 1, 2, 1], null);
        });
        function residl() {
            setidl();
            pla.ani.setAnimation(cliidl);
        }
        pla.residl = residl;
        function setidl() {
            if (pla.verhitdir > 0) {
                pla.ani.off = 0;
                pla.vervel = pla.gra * pla.verhitdir;
            }
            else if (pla.verhitdir < 0) {
                pla.ani.off = 6;
                pla.vervel = pla.gra * pla.verhitdir;
            }
            else if (pla.horhitdir < 0) {
                pla.ani.off = 12;
                pla.horvel = pla.gra * pla.horhitdir;
            }
            else {
                pla.ani.off = 18;
                pla.horvel = pla.gra * pla.horhitdir;
...
(function (Game) {
    ...
    (function (pla) {
        ...
        function entlos() {
            if (Game.goa.win)
                return false;
            if (pla.box.x < 0 || pla.box.x > Game.SceneMap.instance.xSizeMap || pla.box.y < Game.camoff || pla.box.y > Game.SceneMap.instance.ySizeMap + Game.camoff || pla.box.collide(Game.SceneMap.instance.boxesEnemies) != null || pla.box.collide(Game.SceneMap.instance.boxesSolids) != null) {
                pla.los = true;
...
(function (Game) {
    ...
    (function (pla) {
        var cli;
        Game.addAction("init", function () { cli = new Utils.Animation("mov", true, pla.fra, 3, [3, 4, 5, 4], null); });
        var vel = 2.5;
        function resmov() {
            pla.horhit = [];
            pla.verhit = [];
            pla.horhitdir = pla.wal ? (pla.horfli ? 1 : -1) : 0;
            pla.verhitdir = pla.wal ? 0 : (pla.verfli ? -1 : 1);
            pla.horvel = pla.gra * pla.horhitdir;
            pla.vervel = pla.gra * pla.verhitdir;
            var hit = pla.box.cast(Game.SceneMap.instance.boxesSolids, null, true, pla.horvel * 100, pla.horvel != 0, Engine.Box.LAYER_ALL);
            pla.box.translate(hit, true, pla.horvel * 100, true);
            hit = pla.box.cast(Game.SceneMap.instance.boxesSolids, null, false, pla.vervel * 100, pla.vervel != 0, Engine.Box.LAYER_ALL);
            pla.box.translate(hit, false, pla.vervel * 100, true);
            //console.log("wal: "+wal);
            //console.log("verfli: "+verfli);
            //console.log("verhitdir: "+verhitdir);
        }
        pla.resmov = resmov;
        function setmov() {
            if (pla.topcon.cou > 0) {
            ...
            else if (pla.dowcon.cou > 0) {
                pla.horvel = 0;
                pla.vervel = vel;
                pla.ani.off = 6;
            }
            else if (pla.lefcon.cou > 0) {
                pla.horvel = -vel;
                pla.vervel = 0;
                pla.ani.off = 18;
            }
            else if (pla.rigcon.cou > 0) {
                pla.horvel = vel;
                pla.vervel = 0;
                pla.ani.off = 12;
            }
            ...
            pla.lefcon.cou = 0;
            pla.rigcon.cou = 0;
            pla.horhit = pla.verhit = null;
            pla.horhitdir = pla.verhitdir = 0;
            pla.ani.setAnimation(cli);
        ...
        function entmov() {
            if (!pla.mov)
                return false;
            if ((pla.topcon.cou > 0 && pla.verhitdir >= 0) || (pla.dowcon.cou > 0 && pla.verhitdir <= 0) || (pla.lefcon.cou > 0 && pla.horhitdir >= 0) || (pla.rigcon.cou > 0 && pla.horhitdir <= 0)) {
                setmov();
                return true;
            }
            return false;
        ...
        pla.entmov = entmov;
        function linmov() {
            if (Game.LastScene.instance != null && pla.horvel > 0) {
                pla.vervel += pla.gra * 0.5;
            }
            if (pla.entlos())
                return;
            if (pla.entidl())
...
(function (Game) {
    ...
    (function (pla) {
        var ANIM;
        Game.addAction("init", function () {
            //ANIM = new Utils.Animation("anim", false, FRAMES_GOAL_PARTICLES, 1, [5, 5, 5, 5, 5, 6, 6, 7, 7, 8, 9], null);
        });
        var SPEED = 80;
...
(function (Game) {
    ...
    (function (pla) {
        ...
        pla.entjum = entjum;
        function stejum() {
            holjum = coujum < minstejum || (holjum && pla.topcon.inp.down);
    ...
    (function (pla) {
        ...
        function resstu() {
            if (pla.def.flip.y) {
                ...
                //else ani.setAnimation(studir>0?cliidl:cliidlverfli);
                //JumpControl.change();
            }
            else {
                stuhit = null;
        ...
        function linstu() {
            ...
            if (stuhit == null) {
                ...
                /*
                if(!stuhit.hor&&studir<0&&(topcon.cou>0||FallControl.cou>0)){
                    topcon.cou=0;
                    FallControl.cou=0;
                    setfal();
                    exi();
                    Resources.audfal.play();
                    return;
                }
                */
            }
...
(function (Game) {
    ...
    (function (pla) {
        var dowcon;
        (function (dowcon) {
            dowcon.preserved = false;
            dowcon.ste = 5;
            function condes() {
                dowcon.inp = new Game.Control();
                dowcon.inp.enabled = true;
                dowcon.inp.freezeable = true;
                dowcon.inp.listener = dowcon;
                dowcon.inp.useKeyboard = true;
                dowcon.inp.newInteractionRequired = false;
                dowcon.inp.useMouse = false;
                dowcon.inp.mouseButtons = [0];
                dowcon.inp.keys = [Engine.Keyboard.S, Engine.Keyboard.DOWN];
                Engine.System.addListenersFrom(dowcon);
            }
            dowcon.condes = condes;
            function onReset() {
                dowcon.cou = 0;
            }
            dowcon.onReset = onReset;
            function onStepUpdate() {
                if (!Game.SceneFreezer.stoped) {
                    dowcon.cou--;
                    dowcon.cou = dowcon.inp.pressed ? dowcon.ste : dowcon.cou;
                }
            }
            dowcon.onStepUpdate = onStepUpdate;
        })(dowcon = pla.dowcon || (pla.dowcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        ...
        (function (dowcon) {
            ...
            Game.addAction("configure", function () {
                if (Game.plu)
                    fra = Game.FrameSelector.complex("dowcon", Game.Resources.texgam, 178, 818);
                else
                    fra = Game.FrameSelector.complex("dowcon", Game.Resources.texgam, 583, 269);
            });
            function contou() {
                if (Game.IS_TOUCH) {
                    dowcon.inp.useTouch = true;
                    dowcon.inp.bounds = new Engine.Sprite();
                    dowcon.inp.bounds.enabled = true;
                    dowcon.inp.bounds.pinned = true;
                    fra[0].applyToSprite(dowcon.inp.bounds);
                    dowcon.inp.listener = dowcon;
                    dowcon.inp.onPressedDelegate = function () { fra[1].applyToSprite(dowcon.inp.bounds); };
                    dowcon.inp.onReleasedDelegate = function () { fra[0].applyToSprite(dowcon.inp.bounds); };
                }
            }
            dowcon.contou = contou;
            function onViewUpdate() {
                if (Game.IS_TOUCH) {
                    dowcon.inp.bounds.x = Math.floor(pla.topcon.inp.bounds.x - dowcon.inp.bounds.xSize);
                    dowcon.inp.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - dowcon.inp.bounds.ySize) + 1;
                }
            }
            dowcon.onViewUpdate = onViewUpdate;
            function onDrawControlsUnpaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && !Game.SceneFreezer.stoped)
                    dowcon.inp.bounds.render();
            }
            dowcon.onDrawControlsUnpaused = onDrawControlsUnpaused;
            ...
            dowcon.onDrawControlsPaused = onDrawControlsPaused;
        })(dowcon = pla.dowcon || (pla.dowcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        var lefcon;
        (function (lefcon) {
            lefcon.preserved = false;
            lefcon.ste = 5;
            function condes() {
                lefcon.inp = new Game.Control();
                lefcon.inp.enabled = true;
                lefcon.inp.freezeable = true;
                lefcon.inp.listener = lefcon;
                lefcon.inp.useKeyboard = true;
                lefcon.inp.newInteractionRequired = false;
                lefcon.inp.useMouse = false;
                lefcon.inp.mouseButtons = [0];
                lefcon.inp.keys = [Engine.Keyboard.A, Engine.Keyboard.LEFT];
                Engine.System.addListenersFrom(lefcon);
            }
            lefcon.condes = condes;
            function onReset() {
                lefcon.cou = 0;
            }
            lefcon.onReset = onReset;
            function onStepUpdate() {
                if (!Game.SceneFreezer.stoped) {
                    lefcon.cou--;
                    lefcon.cou = lefcon.inp.pressed ? lefcon.ste : lefcon.cou;
                }
            }
            lefcon.onStepUpdate = onStepUpdate;
        })(lefcon = pla.lefcon || (pla.lefcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        ...
        (function (lefcon) {
            ...
            Game.addAction("configure", function () {
                if (Game.plu)
                    fra = Game.FrameSelector.complex("lefcon", Game.Resources.texgam, 0, 818);
                else
                    fra = Game.FrameSelector.complex("lefcon", Game.Resources.texgam, 313, 269);
            });
            function contou() {
                if (Game.IS_TOUCH) {
                    lefcon.inp.useTouch = true;
                    lefcon.inp.bounds = new Engine.Sprite();
                    lefcon.inp.bounds.enabled = true;
                    lefcon.inp.bounds.pinned = true;
                    fra[0].applyToSprite(lefcon.inp.bounds);
                    lefcon.inp.listener = lefcon;
                    lefcon.inp.onPressedDelegate = function () { fra[1].applyToSprite(lefcon.inp.bounds); };
                    lefcon.inp.onReleasedDelegate = function () { fra[0].applyToSprite(lefcon.inp.bounds); };
                }
            }
            lefcon.contou = contou;
            function onViewUpdate() {
                if (Game.IS_TOUCH) {
                    lefcon.inp.bounds.x = -Engine.Renderer.xSizeView * 0.5;
                    lefcon.inp.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - lefcon.inp.bounds.ySize) + 1;
                }
            }
            lefcon.onViewUpdate = onViewUpdate;
            function onDrawControlsUnpaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && !Game.SceneFreezer.stoped)
                    lefcon.inp.bounds.render();
            }
            lefcon.onDrawControlsUnpaused = onDrawControlsUnpaused;
            function onDrawControlsPaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && Game.SceneFreezer.stoped)
            ...
            lefcon.onDrawControlsPaused = onDrawControlsPaused;
        })(lefcon = pla.lefcon || (pla.lefcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        var rigcon;
        (function (rigcon) {
            rigcon.preserved = false;
            rigcon.ste = 5;
            function condes() {
                rigcon.inp = new Game.Control();
                rigcon.inp.enabled = true;
                rigcon.inp.freezeable = true;
                rigcon.inp.listener = rigcon;
                rigcon.inp.useKeyboard = true;
                rigcon.inp.newInteractionRequired = false;
                rigcon.inp.useMouse = false;
                rigcon.inp.mouseButtons = [0];
                rigcon.inp.keys = [Engine.Keyboard.D, Engine.Keyboard.RIGHT];
                Engine.System.addListenersFrom(rigcon);
            }
            rigcon.condes = condes;
            function onReset() {
                rigcon.cou = 0;
            }
            rigcon.onReset = onReset;
            function onStepUpdate() {
                if (!Game.SceneFreezer.stoped) {
                    rigcon.cou--;
                    rigcon.cou = rigcon.inp.pressed ? rigcon.ste : rigcon.cou;
                }
            }
            rigcon.onStepUpdate = onStepUpdate;
        })(rigcon = pla.rigcon || (pla.rigcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        ...
        (function (rigcon) {
            ...
            function contou() {
                if (Game.IS_TOUCH) {
                    rigcon.inp.useTouch = true;
                    rigcon.inp.bounds = new Engine.Sprite();
                    rigcon.inp.bounds.enabled = true;
                    rigcon.inp.bounds.pinned = true;
                    fra[0].applyToSprite(rigcon.inp.bounds);
                    rigcon.inp.listener = rigcon;
                    rigcon.inp.onPressedDelegate = function () { fra[1].applyToSprite(rigcon.inp.bounds); };
                    rigcon.inp.onReleasedDelegate = function () { fra[0].applyToSprite(rigcon.inp.bounds); };
                }
            }
            rigcon.contou = contou;
            function onViewUpdate() {
                if (Game.IS_TOUCH) {
                    rigcon.inp.bounds.x = Math.floor(pla.lefcon.inp.bounds.x + pla.lefcon.inp.bounds.xSize);
                    rigcon.inp.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - rigcon.inp.bounds.ySize) + 1;
                }
            }
            rigcon.onViewUpdate = onViewUpdate;
            function onDrawControlsUnpaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && !Game.SceneFreezer.stoped)
                    rigcon.inp.bounds.render();
            }
            rigcon.onDrawControlsUnpaused = onDrawControlsUnpaused;
            function onDrawControlsPaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && Game.SceneFreezer.stoped)
            ...
            rigcon.onDrawControlsPaused = onDrawControlsPaused;
        })(rigcon = pla.rigcon || (pla.rigcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        var topcon;
        (function (topcon) {
            topcon.preserved = false;
            topcon.ste = 5;
            function condes() {
                topcon.inp = new Game.Control();
                topcon.inp.enabled = true;
                topcon.inp.freezeable = true;
                topcon.inp.listener = topcon;
                topcon.inp.useKeyboard = true;
                topcon.inp.newInteractionRequired = false;
                topcon.inp.useMouse = false;
                topcon.inp.mouseButtons = [0];
                topcon.inp.keys = [Engine.Keyboard.W, Engine.Keyboard.UP];
                Engine.System.addListenersFrom(topcon);
            }
            topcon.condes = condes;
            function onReset() {
                topcon.cou = 0;
            }
            topcon.onReset = onReset;
            function onStepUpdate() {
                if (!Game.SceneFreezer.stoped) {
                    topcon.cou--;
                    topcon.cou = topcon.inp.pressed ? topcon.ste : topcon.cou;
                }
            }
            topcon.onStepUpdate = onStepUpdate;
        })(topcon = pla.topcon || (pla.topcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    (function (pla) {
        ...
        (function (topcon) {
            ...
            Game.addAction("configure", function () {
                if (Game.plu)
                    fra = Game.FrameSelector.complex("topcon", Game.Resources.texgam, 178, 818);
                else
                    fra = Game.FrameSelector.complex("topcon", Game.Resources.texgam, 491, 269);
            });
            function contou() {
                if (Game.IS_TOUCH) {
                    topcon.inp.useTouch = true;
                    topcon.inp.bounds = new Engine.Sprite();
                    topcon.inp.bounds.enabled = true;
                    topcon.inp.bounds.pinned = true;
                    fra[0].applyToSprite(topcon.inp.bounds);
                    topcon.inp.listener = topcon;
                    topcon.inp.onPressedDelegate = function () { fra[1].applyToSprite(topcon.inp.bounds); };
                    topcon.inp.onReleasedDelegate = function () { fra[0].applyToSprite(topcon.inp.bounds); };
                }
            }
            topcon.contou = contou;
            function onViewUpdate() {
                if (Game.IS_TOUCH) {
                    topcon.inp.bounds.x = Engine.Renderer.xSizeView * 0.5 - topcon.inp.bounds.xSize;
                    topcon.inp.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - topcon.inp.bounds.ySize) + 1;
                }
            }
            topcon.onViewUpdate = onViewUpdate;
            function onDrawControlsUnpaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && !Game.SceneFreezer.stoped)
                    topcon.inp.bounds.render();
            }
            topcon.onDrawControlsUnpaused = onDrawControlsUnpaused;
            function onDrawControlsPaused() {
                if (!pla.mov)
                    return;
                if (Game.IS_TOUCH && Game.SceneFreezer.stoped)
            ...
            topcon.onDrawControlsPaused = onDrawControlsPaused;
        })(topcon = pla.topcon || (pla.topcon = {}));
    })(pla = Game.pla || (Game.pla = {}));
})(Game || (Game = {}));
var Game;
