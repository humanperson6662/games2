(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/Template.loader.js";
    var config = {
        dataUrl: buildUrl + "/Template.data",
        frameworkUrl: buildUrl + "/Template.framework.js",
        codeUrl: buildUrl + "/Template.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "@kanartstudio x @coolsorcery",
        productName: "ScrapLegs",
        productVersion: "",
    };
