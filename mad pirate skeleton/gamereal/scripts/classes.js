...
class MainMenu {
    constructor() {
        ...
        window.addEventListener("click", function () {
            ...
            //AG
            if (pointSquareCol(cursor.mapPos, mainMenu.armorGames)) {
                window.open("https://armor.ag/MoreGames");
            }
            if (pointSquareCol(cursor.mapPos, mainMenu.armorLike)) {
                window.open("https://www.facebook.com/ArmorGames");
            }
    ...
    computeMain() {
        ...
        // AG
        if (pointSquareCol(cursor.mapPos, this.armorGames)) {
            this.armorGames.action = 1;
        } else {
            this.armorGames.action = 0;
        }
        
        if (pointSquareCol(cursor.mapPos, this.armorLike)) {
            this.armorLike.action = 1;
        } else {
            this.armorLike.action = 0;
        }
    ...
    renderMain() {
        ...
        c.drawImage(
            this.sheet,
            this.armorGames.actionX[this.armorGames.action] * meta.tilesize,
            this.armorGames.actionY[this.armorGames.action] * meta.tilesize,
            this.armorGames.w * meta.tilesize,
            this.armorGames.h * meta.tilesize,
            this.armorGames.x * meta.tilesize * meta.ratio,
            this.armorGames.y * meta.tilesize * meta.ratio,
            this.armorGames.w * meta.tilesize * meta.ratio,
            this.armorGames.h * meta.tilesize * meta.ratio
        )
        //armorLike
        c.drawImage(
            this.sheet,
            this.armorLike.actionX[this.armorLike.action] * meta.tilesize,
            this.armorLike.actionY[this.armorLike.action] * meta.tilesize,
            this.armorLike.w * meta.tilesize,
            this.armorLike.h * meta.tilesize,
            this.armorLike.x * meta.tilesize * meta.ratio,
            this.armorLike.y * meta.tilesize * meta.ratio,
            this.armorLike.w * meta.tilesize * meta.ratio,
            this.armorLike.h * meta.tilesize * meta.ratio
        )
...
class Cursor {
    ...
    onLockChange() {
        if (document.pointerLockElement === canvas ||
            ...
            cursor.locked = true;
            cursor.lockedMouse.x = cursor.mapPos.x * meta.ratio * meta.tilesize;
            cursor.lockedMouse.y = cursor.mapPos.y * meta.ratio * meta.tilesize;
        } else {
            cursor.locked = false;
