...
var external_buttons = [0,0,0,0,0,0,0,0];
...
// Letting you tweak buttons externally
function updateExternalGamepad(player, buttons) {
	external_buttons[player] = buttons;
}
...
function updateGamepads() {
  ...
  for (var i = 0; i < gamepads.length; i++) {
	...
	// apply external gamepad buttons
	for (var p = 0; p < supportedPlayers; p++) {
		pico8_buttons[p] |= external_buttons[p];
	}
